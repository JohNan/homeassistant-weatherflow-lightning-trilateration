...
class N extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.initialized=!1,this.knownStrikes=new Set,this.stations=[{id:"Primary (Home)",x:0,z:0,color:1096065},{id:"Neighbor 1",x:10,z:10,color:3718648},{id:"Neighbor 2",x:-10,z:10,color:3718648}],this.domeRings=[],this.strikeLayer=null,this.strikeHistory=[],this.isPlaying=!1,this.playbackMode="live",this.playbackTime=Date.now(),this.playbackSpeed=120,this.lastTickTime=Date.now(),this.lastPlayTickTime=Date.now(),this.lastInteractionTime=Date.now(),this.heatmapMeshes=new Map,this.elevationGrid=[],this.glowTexture=null,this.heatGeo=null,this.lastRefLat=null,this.lastRefLon=null,this.windSpeed=0,this.windDirection=0,this.solarRadiation=1e3,this.rainRate=0,this.rainParticles=null,this.windParticles=null,this.lastFrameTime=null}static getConfigElement(){return document.createElement("weatherflow-lightning-card-editor")}static getStubConfig(){return{height:"350px"}}setConfig(t){if(!t)throw new Error("Invalid configuration");const s=this.config;if(this.config={height:"350px",show_grid:!0,show_map:!0,show_rings:!0,show_heatmap:!0,auto_orbit:!0,zoom_level:18,show_weather:!0,show_daynight:!0,min_brightness:.8,elevation_scale:1.5,show_3d_features:!1,playback_speed:120,...t},this.playbackSpeed=parseFloat(this.config.playback_speed)||120,this.speedSelect&&(this.speedSelect.value=this.playbackSpeed.toString()),this.container){const e=this.config.height;if(e.endsWith("px")){const n=parseInt(e);this.container.style.height=`${n-40}px`}else this.container.style.height=e}this.initialized&&this.applyConfigChanges(s||{})}applyConfigChanges(t){if(this.terrainWire&&(this.terrainWire.visible=this.config.show_grid!==!1),this.rangeRingsGroup&&(this.rangeRingsGroup.visible=this.config.show_rings!==!1),this.config.show_weather===!1?(this.rainParticles&&(this.rainParticles.visible=!1),this.windParticles&&(this.windParticles.visible=!1),this.weatherOverlay&&(this.weatherOverlay.style.display="none")):this.weatherOverlay&&(this.weatherOverlay.style.display="flex"),t.show_map!==this.config.show_map&&(this.config.show_map?this.lastRefLat&&this.lastRefLon&&this.loadMapTexture(this.lastRefLat,this.lastRefLon):this.terrainMesh&&this.terrainMesh.material&&(this.terrainMesh.material.map=null,this.terrainMesh.material.color.setHex(330516),this.terrainMesh.material.needsUpdate=!0)),(t.show_daynight!==this.config.show_daynight||t.min_brightness!==this.config.min_brightness)&&this.updateDayNightEngine(),t.zoom_level!==this.config.zoom_level){const s=parseFloat(this.config.zoom_level);isNaN(s)||(this.zoomRadius=s,this.updateCameraPosition())}t.elevation_scale!==this.config.elevation_scale&&(this.elevationGrid&&this.elevationGrid.length===225?this.updateTerrainGeometry(this.elevationGrid):this.generateProceduralTerrain()),t.show_3d_features!==this.config.show_3d_features&&(this.config.show_3d_features?this.lastRefLat&&this.lastRefLon&&this.loadVectorData(this.lastRefLat,this.lastRefLon):(this.features3DGroup&&(this.scene.remove(this.features3DGroup),this.features3DGroup=null),this.vectorDataLoaded=!1))}connectedCallback(){if(window.THREE)this.initVisualizer();else{const t=document.createElement("script");t.src="/weatherflow_lightning_trilateration/three.min.js",t.onload=()=>this.initVisualizer(),document.head.appendChild(t)}}disconnectedCallback(){this.cleanupThreeJS()}cleanupThreeJS(){if(this.isPlaying=!1,this.animationFrameId&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this._mouseupHandler&&(window.removeEventListener("mouseup",this._mouseupHandler),this._mouseupHandler=null),this.features3DGroup&&(this.scene.remove(this.features3DGroup),this.disposeHierarchy(this.features3DGroup),this.features3DGroup=null),this.stationMeshes&&(this.stationMeshes.forEach(t=>{this.scene.remove(t.mesh),this.disposeHierarchy(t.mesh)}),this.stationMeshes=[]),this.heatmapMeshes){for(const t of this.heatmapMeshes.values())this.scene.remove(t.mesh),t.material&&t.material.dispose();this.heatmapMeshes.clear()}this.rangeRingsGroup&&(this.scene.remove(this.rangeRingsGroup),this.disposeHierarchy(this.rangeRingsGroup),this.rangeRingsGroup=null),this.strikeLayer&&(this.scene.remove(this.strikeLayer),this.disposeHierarchy(this.strikeLayer),this.strikeLayer=null),this.terrainMesh&&(this.scene.remove(this.terrainMesh),this.terrainMesh.geometry&&this.terrainMesh.geometry.dispose(),this.terrainMesh.material&&(this.terrainMesh.material.map&&this.terrainMesh.material.map.dispose(),this.terrainMesh.material.dispose())),this.terrainWire&&(this.scene.remove(this.terrainWire),this.terrainWire.geometry&&this.terrainWire.geometry.dispose(),this.terrainWire.material&&this.terrainWire.material.dispose()),this.starField&&(this.scene.remove(this.starField),this.starField.geometry&&this.starField.geometry.dispose(),this.starField.material&&this.starField.material.dispose()),this.rainParticles&&(this.scene.remove(this.rainParticles),this.rainParticles.geometry&&this.rainParticles.geometry.dispose(),this.rainParticles.material&&this.rainParticles.material.dispose()),this.windParticles&&(this.scene.remove(this.windParticles),this.windParticles.geometry&&this.windParticles.geometry.dispose(),this.windParticles.material&&this.windParticles.material.dispose()),this.heatGeo&&this.heatGeo.dispose(),this.glowTexture&&this.glowTexture.dispose(),this.ambientLight&&this.scene.remove(this.ambientLight),this.dirLight&&this.scene.remove(this.dirLight),this.renderer&&(this.renderer.domElement&&this.renderer.domElement.parentNode&&this.renderer.domElement.parentNode.removeChild(this.renderer.domElement),this.renderer.dispose(),this.renderer=null),this.wrapper&&this.wrapper.parentNode&&(this.wrapper.parentNode.removeChild(this.wrapper),this.wrapper=null),this.initialized=!1}disposeHierarchy(t){t&&t.traverse(s=>{s.geometry&&s.geometry.dispose(),s.material&&(Array.isArray(s.material)?s.material.forEach(e=>e.dispose()):s.material.dispose())})}updateCameraPosition(){this.cameraPhi=Math.max(.1,Math.min(Math.PI/2-.05,this.cameraPhi)),this.zoomRadius=Math.max(10,Math.min(150,this.zoomRadius));const t=this.zoomRadius*Math.sin(this.cameraPhi)*Math.sin(this.cameraTheta),s=this.zoomRadius*Math.cos(this.cameraPhi),e=this.zoomRadius*Math.sin(this.cameraPhi)*Math.cos(this.cameraTheta);this.camera&&(this.camera.position.set(t,s,e),this.camera.lookAt(0,0,0))}initVisualizer(){if(this.initialized)return;this.initialized=!0,this.wrapper=document.createElement("div"),this.wrapper.style.position="relative",this.wrapper.style.width="100%",this.wrapper.style.display="flex",this.wrapper.style.flexDirection="column",this.wrapper.style.backgroundColor="#02040a",this.wrapper.style.borderRadius="12px",this.wrapper.style.overflow="hidden",this.wrapper.style.border="1px solid rgba(56, 189, 248, 0.15)",this.shadowRoot.appendChild(this.wrapper),this.container=document.createElement("div"),this.container.style.position="relative",this.container.style.width="100%";const t=this.config.height||"350px";if(t.endsWith("px")){const i=parseInt(t);this.container.style.height=`${i-40}px`}else this.container.style.height=t;this.container.style.overflow="hidden",this.container.style.cursor="grab",this.container.style.userSelect="none",this.container.style.webkitUserSelect="none",this.container.style.touchAction="none",this.wrapper.appendChild(this.container),this.createPlaybackControls(),this.scene=new THREE.Scene,this.scene.fog=new THREE.FogExp2(132106,.005);const s=this.container.clientWidth/this.container.clientHeight;this.camera=new THREE.PerspectiveCamera(60,s,.1,1e3),this.zoomRadius=this.config.zoom_level!==void 0?parseFloat(this.config.zoom_level):18,this.cameraTheta=0,this.cameraPhi=Math.atan2(30,15),this.updateCameraPosition(),this.renderer=new THREE.WebGLRenderer({antialias:!0}),this.renderer.setSize(this.container.clientWidth,this.container.clientHeight),this.renderer.setClearColor(132106,1),this.renderer.setPixelRatio(window.devicePixelRatio||1),this.container.appendChild(this.renderer.domElement),this.tooltip=document.createElement("div"),this.tooltip.style.position="absolute",this.tooltip.style.backgroundColor="rgba(8, 12, 20, 0.95)",this.tooltip.style.color="#e2e8f0",this.tooltip.style.padding="8px 12px",this.tooltip.style.borderRadius="6px",this.tooltip.style.border="1px solid rgba(56, 189, 248, 0.4)",this.tooltip.style.fontSize="12px",this.tooltip.style.pointerEvents="none",this.tooltip.style.display="none",this.tooltip.style.zIndex="10",this.tooltip.style.fontFamily="sans-serif",this.tooltip.style.boxShadow="0 4px 12px rgba(0, 0, 0, 0.5)",this.container.appendChild(this.tooltip);const e=document.createElement("style");e.textContent=`
    ...
    `,this.container.appendChild(e),this.weatherOverlay=document.createElement("div"),this.weatherOverlay.className="weather-telemetry-hud",this.weatherOverlay.style.display=this.config.show_weather!==!1?"flex":"none",this.container.appendChild(this.weatherOverlay),this.hudCollapsed=!1;const n=i=>i.stopPropagation();["mousedown","mousemove","mouseup","click","touchstart","touchmove","touchend","wheel"].forEach(i=>{this.weatherOverlay.addEventListener(i,n)}),this.weatherOverlay.addEventListener("click",i=>{(i.target.closest(".hud-toggle-btn")||this.hudCollapsed)&&(i.stopPropagation(),this.hudCollapsed=!this.hudCollapsed,this.hudCollapsed?(this.weatherOverlay.classList.add("collapsed"),this.weatherOverlay.title="Expand Weather HUD"):(this.weatherOverlay.classList.remove("collapsed"),this.weatherOverlay.removeAttribute("title")),this.updateWeatherOverlay())}),this.raycaster=new THREE.Raycaster,this.mouse=new THREE.Vector2,this.glowTexture=this.createGlowTexture(),this.heatGeo=new THREE.SphereGeometry(.15,8,8),this.lastInteractionTime=Date.now();let h=!1,r={x:0,y:0};this.container.addEventListener("mousedown",i=>{this.lastInteractionTime=Date.now(),h=!0,this.container.style.cursor="grabbing",r={x:i.clientX,y:i.clientY}}),this.container.addEventListener("mousemove",i=>{if(this.lastInteractionTime=Date.now(),h){const a=i.clientX-r.x,l=i.clientY-r.y;this.cameraTheta-=a*.005,this.cameraPhi+=l*.005,this.updateCameraPosition(),r={x:i.clientX,y:i.clientY}}else{const a=this.renderer.domElement.getBoundingClientRect();this.mouse.x=(i.clientX-a.left)/a.width*2-1,this.mouse.y=-((i.clientY-a.top)/a.height)*2+1,this.checkHover(i.clientX-a.left,i.clientY-a.top)}}),this._mouseupHandler=()=>{h=!1,this.container.style.cursor="grab"},window.addEventListener("mouseup",this._mouseupHandler),this.container.addEventListener("mouseleave",()=>{this.hideTooltip()}),this.container.addEventListener("wheel",i=>{this.lastInteractionTime=Date.now(),this.hideTooltip(),i.preventDefault(),this.zoomRadius+=i.deltaY*.02,this.updateCameraPosition()},{passive:!1});let c=0;this.container.addEventListener("touchstart",i=>{this.lastInteractionTime=Date.now(),this.hideTooltip(),i.touches.length===1?(h=!0,r={x:i.touches[0].clientX,y:i.touches[0].clientY}):i.touches.length===2&&(h=!1,c=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY))}),this.container.addEventListener("touchmove",i=>{if(this.lastInteractionTime=Date.now(),i.preventDefault(),i.touches.length===1&&h){const a=i.touches[0].clientX-r.x,l=i.touches[0].clientY-r.y;this.cameraTheta-=a*.007,this.cameraPhi+=l*.007,this.updateCameraPosition(),r={x:i.touches[0].clientX,y:i.touches[0].clientY}}else if(i.touches.length===2){const a=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY),l=a-c;this.zoomRadius-=l*.15,this.updateCameraPosition(),c=a}},{passive:!1}),this.container.addEventListener("touchend",()=>{h=!1}),this.addStaticElements(),this.initWeatherSystem(),this.updateDayNightEngine(),this.addWeatherStations(),this.generateProceduralTerrain(),this.strikeLayer=new THREE.Group,this.scene.add(this.strikeLayer),this.resizeObserver=new ResizeObserver(()=>{if(this.renderer&&this.container){const i=this.container.clientWidth,a=this.container.clientHeight;this.camera.aspect=i/a,this.camera.updateProjectionMatrix(),this.renderer.setSize(i,a)}}),this.resizeObserver.observe(this.container),this.animateLoop(),this._hass&&(console.log("WeatherFlow Card: Re-applying cached state on init completion"),this.hass=this._hass)}createGlowTexture(){const t=document.createElement("canvas");t.width=64,t.height=64;const s=t.getContext("2d"),e=s.createRadialGradient(32,32,0,32,32,32);return e.addColorStop(0,"rgba(0, 242, 254, 1.0)"),e.addColorStop(.2,"rgba(0, 242, 254, 0.8)"),e.addColorStop(.5,"rgba(239, 68, 68, 0.3)"),e.addColorStop(1,"rgba(0, 0, 0, 0)"),s.fillStyle=e,s.fillRect(0,0,64,64),new THREE.CanvasTexture(t)}createRingLabelSprite(t){const s=document.createElement("canvas");s.width=128,s.height=64;const e=s.getContext("2d");e.fillStyle="rgba(0, 0, 0, 0)",e.fillRect(0,0,128,64),e.font="bold 24px sans-serif",e.fillStyle="#00f2fe",e.textAlign="center",e.textBaseline="middle",e.fillText(t,64,32);const n=new THREE.CanvasTexture(s),o=new THREE.SpriteMaterial({map:n,transparent:!0,depthWrite:!1,depthTest:!0}),h=new THREE.Sprite(o);return h.scale.set(2,1,1),h}addRangeRings(){this.rangeRingsGroup=new THREE.Group,this.rangeRingsGroup.visible=this.config.show_rings!==!1,this.scene.add(this.rangeRingsGroup);const t=[10,20,30];t.forEach(a=>{const l=[];for(let m=0;m<=128;m++){const f=m/128*Math.PI*2,g=a*Math.cos(f),v=a*Math.sin(f);l.push(new THREE.Vector3(g,.05,v))}const p=new THREE.BufferGeometry().setFromPoints(l),u=new THREE.LineBasicMaterial({color:62206,transparent:!0,opacity:.5}),y=new THREE.Line(p,u);this.rangeRingsGroup.add(y)});const s=new THREE.LineBasicMaterial({color:62206,transparent:!0,opacity:.3}),e=[],n=40;for(let a=0;a<=n;a++){const l=-30+a/n*60;e.push(new THREE.Vector3(0,.05,l))}const o=new THREE.BufferGeometry().setFromPoints(e),h=new THREE.Line(o,s);this.rangeRingsGroup.add(h);const r=[];for(let a=0;a<=n;a++){const l=-30+a/n*60;r.push(new THREE.Vector3(l,.05,0))}const c=new THREE.BufferGeometry().setFromPoints(r),i=new THREE.Line(c,s);this.rangeRingsGroup.add(i),this.ringLabels=[],t.forEach(a=>{const l=this.createRingLabelSprite(`${a}km`);l.position.set(.8,.5,-a),this.rangeRingsGroup.add(l),this.ringLabels.push({sprite:l,r:a})})}updateRangeRings(){if(!this.rangeRingsGroup||!this.rangeRingsGroup.children)return;const t=this.rangeRingsGroup.children;[10,20,30].forEach((o,h)=>{const r=t[h];if(r){const c=r.geometry.attributes.position,i=128;for(let a=0;a<=i;a++){const l=a/i*Math.PI*2,d=o*Math.cos(l),p=o*Math.sin(l),u=this.getTerrainHeight(d,p)+.1;c.setY(a,u)}c.needsUpdate=!0}});const e=t[3];if(e){const o=e.geometry.attributes.position,h=40;for(let r=0;r<=h;r++){const c=-30+r/h*60,i=this.getTerrainHeight(0,c)+.1;o.setXYZ(r,0,i,c)}o.needsUpdate=!0}const n=t[4];if(n){const o=n.geometry.attributes.position,h=40;for(let r=0;r<=h;r++){const c=-30+r/h*60,i=this.getTerrainHeight(c,0)+.1;o.setXYZ(r,c,i,0)}o.needsUpdate=!0}this.ringLabels&&this.ringLabels.forEach(o=>{const r=-o.r,c=this.getTerrainHeight(.8,r)+.4;o.sprite.position.set(.8,c,r)})}getTerrainHeight(t,s){if(!this.elevationGrid||this.elevationGrid.length!==225)return 0;const e=(t+20)*14/40,n=(s+20)*14/40;if(e<0||e>14||n<0||n>14)return 0;const o=Math.floor(e),h=Math.min(14,o+1),r=Math.floor(n),c=Math.min(14,r+1),i=e-o,a=n-r,l=this.getGridHeight(r,o),d=this.getGridHeight(r,h),p=this.getGridHeight(c,o),u=this.getGridHeight(c,h),y=l*(1-i)+d*i,m=p*(1-i)+u*i;return y*(1-a)+m*a}getGridHeight(t,s){return this.scaledHeights?this.scaledHeights[(14-t)*15+s]:0}generateProceduralTerrain(){this.elevationGrid=[];for(let o=0;o<15;o++){const h=o-7;for(let r=0;r<15;r++){const c=r-7,i=Math.sqrt(h*h+c*c);let a=80+Math.sin(h*.4)*Math.cos(c*.4)*45;if(a+=Math.sin(i*.8)*15,o===7&&r===7)a=100;else{const l=Math.min(1,i/3);a=100*(1-l)+a*l}this.elevationGrid.push(a)}}const t=100,e=(this.config.elevation_scale!==void 0?parseFloat(this.config.elevation_scale):1.5)/1e3;this.scaledHeights=new Float32Array(225);for(let o=0;o<225;o++)this.scaledHeights[o]=((this.elevationGrid[o]||0)-t)*e;const n=this.terrainGeo.attributes.position;for(let o=0;o<=14;o++){const h=14-o;for(let r=0;r<=14;r++){const c=r,i=o*15+r,a=this.scaledHeights[h*15+c];n.setZ(i,a)}}n.needsUpdate=!0,this.terrainGeo.computeVertexNormals(),this.updateStationHeights(),this.updateRangeRings()}loadMapTexture(t,s){if(this.config.show_map===!1){this.terrainMesh&&this.terrainMesh.material&&(this.terrainMesh.material.map=null,this.terrainMesh.material.color.setHex(330516),this.terrainMesh.material.needsUpdate=!0);return}const e=10,n=40,o=n/111.1,h=Math.cos(t*Math.PI/180),r=h>0?n/(111.1*h):n/111.1,c=t-o/2,i=t+o/2,a=s-r/2,l=s+r/2,d=(w,b)=>(w+180)/360*Math.pow(2,b),p=(w,b)=>(1-Math.log(Math.tan(w*Math.PI/180)+1/Math.cos(w*Math.PI/180))/Math.PI)/2*Math.pow(2,b),u=(w,b)=>w/Math.pow(2,b)*360-180,y=(w,b)=>Math.atan(Math.sinh(Math.PI-2*Math.PI*w/Math.pow(2,b)))*180/Math.PI,m=Math.floor(d(a,e)),f=Math.floor(d(l,e)),g=Math.floor(p(i,e)),v=Math.floor(p(c,e)),E=document.createElement("canvas");E.width=1024,E.height=1024;const x=E.getContext("2d");x.fillStyle="#050b14",x.fillRect(0,0,1024,1024);const M=[];for(let w=m;w<=f;w++)for(let b=g;b<=v;b++){const L=u(w,e),P=u(w+1,e),S=y(b+1,e),C=y(b,e),_=(L-a)/(l-a),I=(P-a)/(l-a),z=(S-c)/(i-c),R=(C-c)/(i-c),G=_*1024,F=(1-R)*1024,D=(I-_)*1024,B=(R-z)*1024,W=`https://basemaps.cartocdn.com/dark_all/${e}/${w}/${b}.png`,A=new Promise(H=>{const T=new Image;T.crossOrigin="anonymous",T.onload=()=>{x.drawImage(T,G,F,D,B),H()},T.onerror=()=>H(),T.src=W});M.push(A)}Promise.all(M).then(()=>{const w=new THREE.CanvasTexture(E);this.terrainMesh&&this.terrainMesh.material&&(this.terrainMesh.material.map=w,this.terrainMesh.material.color.setHex(16777215),this.terrainMesh.material.needsUpdate=!0)})}async loadVectorData(t,s){this.vectorDataLoading=!0;try{const e=await this._hass.callApi("GET","weatherflow_lightning/vector_data");this.render3DFeatures(e,t,s),this.vectorDataLoaded=!0}catch(e){console.error("Failed to load 3D vector features:",e)}finally{this.vectorDataLoading=!1}}render3DFeatures(t,s,e){if(!this.scene)return;this.features3DGroup&&(this.scene.remove(this.features3DGroup),this.features3DGroup.traverse(h=>{h.geometry&&h.geometry.dispose(),h.material&&(Array.isArray(h.material)?h.material.forEach(r=>r.dispose()):h.material.dispose())})),this.features3DGroup=new THREE.Group,this.scene.add(this.features3DGroup);const n=6371,o=Math.cos(s*Math.PI/180);if(t.water&&Array.isArray(t.water)){const h=new THREE.MeshPhongMaterial({color:165063,transparent:!0,opacity:.5,side:THREE.DoubleSide,flatShading:!0});t.water.forEach(r=>{if(!r.coordinates||r.coordinates.length<3)return;const c=[];let i=0,a=0;if(r.coordinates.forEach(u=>{const y=u[0],m=u[1],f=n*(m-e)*(Math.PI/180)*o,g=-n*(y-s)*(Math.PI/180);f<-20||f>20||g<-20||g>20||(c.push(new THREE.Vector2(f,-g)),i+=this.getTerrainHeight(f,g),a++)}),c.length<3)return;i/=a;const l=new THREE.Shape(c),d=new THREE.ShapeGeometry(l),p=new THREE.Mesh(d,h);p.rotation.x=-Math.PI/2,p.position.y=i+.08,this.features3DGroup.add(p)})}if(t.forest&&Array.isArray(t.forest)){const h=[];if(t.forest.forEach(r=>{!r.coordinates||r.coordinates.length<3||r.coordinates.forEach((c,i)=>{if(i%4!==0)return;const a=c[0],l=c[1],d=n*(l-e)*(Math.PI/180)*o,p=-n*(a-s)*(Math.PI/180);if(d<-19.5||d>19.5||p<-19.5||p>19.5)return;const u=this.getTerrainHeight(d,p);h.push(new THREE.Vector3(d,u,p))})}),h.length>0){const r=new THREE.ConeGeometry(.12,.45,4);r.translate(0,.225,0);const c=new THREE.MeshPhongMaterial({color:1467700,flatShading:!0}),i=new THREE.InstancedMesh(r,c,h.length),a=new THREE.Object3D;h.forEach((l,d)=>{a.position.copy(l);const p=.8+Math.random()*.4;a.scale.set(p,p,p),a.updateMatrix(),i.setMatrixAt(d,a.matrix)}),i.instanceMatrix.needsUpdate=!0,this.features3DGroup.add(i)}}}updateTerrainGeometry(t){if(!t||t.length!==225){this.generateProceduralTerrain();return}this.elevationGrid=t;const s=7*15+7,e=t[s]||0,o=(this.config.elevation_scale!==void 0?parseFloat(this.config.elevation_scale):1.5)/1e3;this.scaledHeights=new Float32Array(225);for(let r=0;r<225;r++)this.scaledHeights[r]=((t[r]||0)-e)*o;const h=this.terrainGeo.attributes.position;for(let r=0;r<=14;r++){const c=14-r;for(let i=0;i<=14;i++){const a=i,l=r*15+i,d=this.scaledHeights[c*15+a];h.setZ(l,d)}}h.needsUpdate=!0,this.terrainGeo.computeVertexNormals(),this.updateStationHeights(),this.updateRangeRings()}updateStationHeights(){!this.stationMeshes||!this.stations||this.stations.forEach((t,s)=>{const e=this.stationMeshes[s];if(e&&e.mesh){const n=this.getTerrainHeight(t.x,t.z);e.mesh.position.y=n}})}showTooltip(t,s,e){if(!this.tooltip)return;let n="Discovered Station";t.type==="primary"?n="Primary Station":t.type==="neighbor"&&(n="Neighbor Station"),this.tooltip.innerHTML=`
    ...
    `,this.tooltip.style.display="block";const o=this.container.getBoundingClientRect();let h=s+15,r=e+15;h+150>o.width&&(h=s-165),r+60>o.height&&(r=e-75),this.tooltip.style.left=`${h}px`,this.tooltip.style.top=`${r}px`}hideTooltip(){this.tooltip&&(this.tooltip.style.display="none")}checkHover(t,s){if(!this.camera||!this.stationMeshes||!this.raycaster)return;this.raycaster.setFromCamera(this.mouse,this.camera);const e=this.raycaster.intersectObjects(this.stationMeshes.map(n=>n.mesh),!0);if(e.length>0){let n=e[0].object;for(;n&&n.parent&&(!n.userData||!n.userData.station);)n=n.parent;if(n&&n.userData&&n.userData.station){const o=n.userData.station;this.showTooltip(o,t,s),this.container.style.cursor="pointer";return}}this.hideTooltip(),this.container.style.cursor==="pointer"&&(this.container.style.cursor="grab")}updateHeatmap(){if(!this.scene)return;const t=9e4,s=this.playbackTime;this.heatmapMeshes||(this.heatmapMeshes=new Map);const e=new Set;for(let n=0;n<this.strikeHistory.length;n++){const o=this.strikeHistory[n],h=s-o.time;if(h>=0&&h<=t){e.add(o.id);const r=h/t,c=.7*(1-r),i=1-r*.4;let a=this.heatmapMeshes.get(o.id);if(a)a.material.opacity=c,a.mesh.scale.set(i,i,i),a.mesh.position.y=this.getTerrainHeight(o.x,o.z);else{const l=new THREE.MeshBasicMaterial({color:16096779,transparent:!0,opacity:c,depthWrite:!1}),d=new THREE.Mesh(this.heatGeo,l),p=this.getTerrainHeight(o.x,o.z);d.position.set(o.x,p,o.z),d.scale.set(i,i,i),this.scene.add(d),a={mesh:d,material:l},this.heatmapMeshes.set(o.id,a)}}}for(const[n,o]of this.heatmapMeshes.entries())e.has(n)||(this.scene.remove(o.mesh),o.material&&o.material.dispose(),this.heatmapMeshes.delete(n))}addStaticElements(){this.ambientLight=new THREE.AmbientLight(988970,1.5),this.scene.add(this.ambientLight),this.dirLight=new THREE.DirectionalLight(3718648,1),this.dirLight.position.set(5,10,7),this.scene.add(this.dirLight);const t=new THREE.BufferGeometry,s=500,e=new Float32Array(s*3);for(let c=0;c<s*3;c+=3){const i=100+Math.random()*50,a=Math.random(),l=Math.random(),d=a*2*Math.PI,p=Math.acos(2*l-1);e[c]=i*Math.sin(p)*Math.cos(d),e[c+1]=i*Math.sin(p)*Math.sin(d),e[c+2]=i*Math.cos(p)}t.setAttribute("position",new THREE.BufferAttribute(e,3));const n=new THREE.PointsMaterial({color:16777215,size:.5,transparent:!0,opacity:.6});this.starField=new THREE.Points(t,n),this.scene.add(this.starField);const o=40;this.terrainGeo=new THREE.PlaneGeometry(o,o,14,14);const h=new THREE.MeshPhongMaterial({color:330516,emissive:66826,specular:1121838,shininess:30,flatShading:!0,side:THREE.DoubleSide});this.terrainMesh=new THREE.Mesh(this.terrainGeo,h),this.terrainMesh.rotation.x=-Math.PI/2,this.scene.add(this.terrainMesh);const r=new THREE.MeshBasicMaterial({color:62206,wireframe:!0,transparent:!0,opacity:.15});this.terrainWire=new THREE.Mesh(this.terrainGeo,r),this.terrainWire.rotation.x=-Math.PI/2,this.terrainWire.visible=this.config.show_grid!==!1,this.scene.add(this.terrainWire),this.addRangeRings()}addWeatherStations(){this.stationMeshes=[],this.stations.forEach(t=>{const s=new THREE.Group,e=this.getTerrainHeight(t.x,t.z);s.position.set(t.x,e,t.z),s.userData={station:t};const n=new THREE.RingGeometry(.8,1,32),o=new THREE.MeshBasicMaterial({color:t.color,transparent:!0,opacity:.8,side:THREE.DoubleSide}),h=new THREE.Mesh(n,o);h.rotation.x=-Math.PI/2,h.position.y=.02,s.add(h);const r=new THREE.CylinderGeometry(.08,.08,2.5,8),c=new THREE.MeshBasicMaterial({color:t.color,transparent:!0,opacity:.6}),i=new THREE.Mesh(r,c);i.position.y=1.25,s.add(i);const a=new THREE.SphereGeometry(.25,16,16),l=new THREE.MeshBasicMaterial({color:t.color}),d=new THREE.Mesh(a,l);d.position.y=2.5,s.add(d),this.scene.add(s),this.stationMeshes.push({mesh:s,pulseVal:Math.random()*Math.PI})})}initWeatherSystem(){const s=new THREE.BufferGeometry,e=new Float32Array(800*3);for(let i=0;i<800*3;i+=3)e[i]=(Math.random()-.5)*40,e[i+1]=Math.random()*20,e[i+2]=(Math.random()-.5)*40;s.setAttribute("position",new THREE.BufferAttribute(e,3));const n=new THREE.PointsMaterial({color:9684477,size:.15,transparent:!0,opacity:.6,depthWrite:!1});this.rainParticles=new THREE.Points(s,n),this.scene.add(this.rainParticles),this.rainParticles.visible=!1;const o=300,h=new THREE.BufferGeometry,r=new Float32Array(o*3);for(let i=0;i<o*3;i+=3)r[i]=(Math.random()-.5)*40,r[i+1]=Math.random()*8,r[i+2]=(Math.random()-.5)*40;h.setAttribute("position",new THREE.BufferAttribute(r,3));const c=new THREE.PointsMaterial({color:3718648,size:.1,transparent:!0,opacity:.3,depthWrite:!1});this.windParticles=new THREE.Points(h,c),this.scene.add(this.windParticles),this.windParticles.visible=!1}updateWeatherOverlay(){if(!this.weatherOverlay)return;const t=(this.windSpeed||0).toFixed(1),s=(this.rainRate||0).toFixed(1),e=this.windDirection||0;if(this.hudCollapsed){this.weatherOverlay.innerHTML=`
    ...
    `,this.wrapper.appendChild(t),this.controls=document.createElement("div"),this.controls.style.display="flex",this.controls.style.alignItems="center",this.controls.style.padding="8px 12px",this.controls.style.backgroundColor="#080c14",this.controls.style.borderTop="1px solid rgba(56, 189, 248, 0.1)",this.controls.style.gap="12px",this.controls.style.fontFamily="var(--paper-font-body1_-_font-family, inherit)",this.controls.style.color="#e2e8f0",this.wrapper.appendChild(this.controls),this.playBtn=document.createElement("button"),this.playBtn.className="play-btn",this.playBtn.innerHTML=this.getPlayIcon(),this.controls.appendChild(this.playBtn),this.slider=document.createElement("input"),this.slider.type="range",this.slider.className="timeline-slider",this.slider.min="0",this.slider.max="1000",this.slider.value="1000",this.controls.appendChild(this.slider),this.speedSelect=document.createElement("select"),this.speedSelect.className="speed-select";const s=[1,5,10,30,60,120,300,600];s.includes(this.playbackSpeed)||(s.push(this.playbackSpeed),s.sort((e,n)=>e-n)),s.forEach(e=>{const n=document.createElement("option");n.value=e.toString(),n.innerText=`${e}x`,e===this.playbackSpeed&&(n.selected=!0),this.speedSelect.appendChild(n)}),this.controls.appendChild(this.speedSelect),this.timeLabel=document.createElement("span"),this.timeLabel.style.fontSize="12px",this.timeLabel.style.minWidth="130px",this.timeLabel.style.textAlign="right",this.timeLabel.style.color="#94a3b8",this.timeLabel.style.fontVariantNumeric="tabular-nums",this.timeLabel.innerText="Live",this.controls.appendChild(this.timeLabel),this.playBtn.addEventListener("click",()=>this.togglePlay()),this.slider.addEventListener("input",e=>this.handleSliderInput(e)),this.slider.addEventListener("change",()=>this.handleSliderChange()),this.speedSelect.addEventListener("change",e=>{this.playbackSpeed=parseFloat(e.target.value)||120})}getPlayIcon(){return'<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M320-203v-554l440 277-440 277Z"/></svg>'}getPauseIcon(){return'<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M560-200v-560h160v560H560Zm-320 0v-560h160v560H240Z"/></svg>'}tickPlayback(){const t=this.strikeHistory.length>0?Math.min(Date.now()-36e5,this.strikeHistory[0].time):Date.now()-36e5,s=Date.now();if(this.slider&&(this.slider.disabled=!1),this.playbackMode==="live")this.playbackTime=s,this.slider&&(this.slider.min=t.toString(),this.slider.max=s.toString(),this.slider.value=s.toString()),this.timeLabel&&(this.timeLabel.innerText="Live");else if(this.isPlaying){const e=Date.now(),n=e-(this.lastPlayTickTime||e);this.lastPlayTickTime=e,this.playbackTime+=n*this.playbackSpeed,this.playbackTime>=s?(this.playbackTime=s,this.setLiveMode()):(this.slider&&(this.slider.min=t.toString(),this.slider.max=s.toString(),this.slider.value=this.playbackTime.toString()),this.updateTimeLabel(),this.checkAndTriggerPlaybackStrikes())}else this.slider&&(this.slider.min=t.toString(),this.slider.max=s.toString()),this.updateTimeLabel()}togglePlay(){const t=this.strikeHistory.length>0?Math.min(Date.now()-36e5,this.strikeHistory[0].time):Date.now()-36e5;this.playbackMode==="live"?(this.playbackMode="playback",this.isPlaying=!0,this.lastPlayTickTime=Date.now(),this.playbackTime=t,this.strikeHistory.forEach(s=>{s.animated=s.time<=this.playbackTime})):(this.isPlaying=!this.isPlaying,this.isPlaying&&(this.lastPlayTickTime=Date.now(),this.playbackTime>=Date.now()&&(this.playbackTime=t,this.strikeHistory.forEach(s=>{s.animated=s.time<=this.playbackTime})))),this.updatePlayBtnIcon()}setLiveMode(){this.playbackMode="live",this.isPlaying=!1,this.updatePlayBtnIcon(),this.slider&&(this.slider.value=Date.now()),this.timeLabel&&(this.timeLabel.innerText="Live"),this.strikeHistory.forEach(t=>t.animated=!0)}updatePlayBtnIcon(){this.isPlaying?(this.playBtn.innerHTML=this.getPauseIcon(),this.playBtn.style.color="#ef4444"):(this.playBtn.innerHTML=this.getPlayIcon(),this.playBtn.style.color="#38bdf8")}updateTimeLabel(){const s=new Date(this.playbackTime).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"}),e=Math.round((Date.now()-this.playbackTime)/1e3);let n="";if(e<60)n=`-${e}s`;else{const o=Math.floor(e/60),h=e%60;n=`-${o}m ${h}s`}this.timeLabel&&(this.timeLabel.innerText=`${s} (${n})`)}handleSliderInput(t){this.playbackMode="playback",this.isPlaying=!1,this.playbackTime=parseFloat(t.target.value),this.updatePlayBtnIcon(),this.updateTimeLabel(),this.strikeHistory.forEach(s=>{s.time<=this.playbackTime?s.animated=!0:s.animated=!1})}handleSliderChange(){}checkAndTriggerPlaybackStrikes(){this.strikeHistory.forEach(t=>{t.time<=this.playbackTime?t.animated||(t.animated=!0,this.triggerStrikeAnimation(t.x,t.z)):t.animated=!1})}createLightningPath(t,s,e=10){const n=[],o=new THREE.Vector3().subVectors(s,t);n.push(t.clone());for(let h=1;h<e;h++){const r=h/e,c=new THREE.Vector3().addVectors(t,o.clone().multiplyScalar(r)),i=(1-r)*1;c.add(new THREE.Vector3((Math.random()-.5)*i,(Math.random()-.5)*i,(Math.random()-.5)*i)),n.push(c)}return n.push(s.clone()),n}createLightningBranches(t,s,e=8){const n=this.createLightningPath(t,s,e),o=[n];for(let h=1;h<n.length-2;h++)if(Math.random()<.25){const r=n[h].clone(),i=(1-h/n.length)*6,a=new THREE.Vector3().subVectors(s,t).normalize();a.add(new THREE.Vector3((Math.random()-.5)*1.5,-.2,(Math.random()-.5)*1.5)).normalize();const l=new THREE.Vector3().addVectors(r,a.multiplyScalar(i)),d=this.createLightningPath(r,l,4);o.push(d)}return o}triggerStrikeAnimation(t,s){if(!this.initialized)return;const e=this.getTerrainHeight(t,s),n=new THREE.Vector3(t,e,s),o=new THREE.Vector3(t+(Math.random()-.5)*4,e+18,s+(Math.random()-.5)*4),h=[];this.createLightningBranches(o,n).forEach((f,g)=>{const E=new THREE.CatmullRomCurve3(f).getPoints(30),x=new THREE.BufferGeometry().setFromPoints(E),M=g===0,w=new THREE.LineBasicMaterial({color:M?16768768:16758528,transparent:!0,opacity:M?1:.7}),b=new THREE.Line(x,w);this.strikeLayer.add(b),h.push(b)});const c=new THREE.SpriteMaterial({map:this.glowTexture,color:16777215,transparent:!0,blending:THREE.AdditiveBlending,depthWrite:!1}),i=new THREE.Sprite(c);i.position.copy(n),i.position.y+=.1,i.scale.set(.1,.1,1),this.strikeLayer.add(i);const a=new THREE.RingGeometry(.1,.2,32),l=new THREE.MeshBasicMaterial({color:15680580,transparent:!0,opacity:.8,side:THREE.DoubleSide}),d=new THREE.Mesh(a,l);d.position.copy(n),d.position.y+=.05,d.rotation.x=-Math.PI/2,this.strikeLayer.add(d);const p=[];this.stations.forEach(f=>{const g=this.getTerrainHeight(f.x,f.z),v=new THREE.Vector3(f.x,g,f.z),E=v.distanceTo(n),x=new THREE.RingGeometry(E-.08,E+.08,64),M=new THREE.MeshBasicMaterial({color:f.color,transparent:!0,opacity:0,side:THREE.DoubleSide}),w=new THREE.Mesh(x,M);w.position.copy(v),w.position.y+=.05,w.rotation.x=-Math.PI/2,this.strikeLayer.add(w),p.push({mesh:w,targetOpacity:.5})});let u=0;const y=60,m=()=>{u++;const f=u/y;if(f<.2?h.forEach(g=>g.material.opacity=Math.random()>.3?1:.2):f<.5?h.forEach(g=>{g.material.opacity=1-(f-.2)/.3}):h.forEach(g=>{g.parent&&(this.strikeLayer.remove(g),g.geometry&&g.geometry.dispose(),g.material&&g.material.dispose())}),f<.6){const g=f*12;i.scale.set(g,g,1),i.material.opacity=1*(1-f/.6)}else i.parent&&(this.strikeLayer.remove(i),i.material.dispose());if(f<.8){const g=1+f*25;d.scale.set(g,g,1),d.material.opacity=.8*(1-f/.8)}else d.parent&&(this.strikeLayer.remove(d),d.geometry&&d.geometry.dispose(),d.material&&d.material.dispose());p.forEach(g=>{f<.3?g.mesh.material.opacity=g.targetOpacity*(f/.3):f<.9?g.mesh.material.opacity=g.targetOpacity*(1-(f-.3)/.6):g.mesh.parent&&(this.strikeLayer.remove(g.mesh),g.mesh.geometry&&g.mesh.geometry.dispose(),g.mesh.material&&g.mesh.material.dispose())}),u<y&&requestAnimationFrame(m)};m()}set hass(t){if(this._hass=t,!t||!this.initialized)return;const s=this.config.entity||this.config.entity_id||Object.keys(t.states).find(a=>a.startsWith("sensor.")&&a.endsWith("_stations")&&t.states[a].attributes.stations!==void 0&&t.states[a].attributes.icon==="mdi:lightning-bolt")||Object.keys(t.states).find(a=>a.startsWith("sensor.")&&t.states[a].attributes.stations!==void 0);let e=t.config.latitude,n=t.config.longitude;if(console.log("WeatherFlow Card: Home coordinates:",e,n),s){const l=t.states[s].attributes.stations;if(Array.isArray(l)){const d=l.find(p=>p.type==="primary");if(d&&d.latitude!==void 0&&d.longitude!==void 0){const p=parseFloat(d.latitude),u=parseFloat(d.longitude);!isNaN(p)&&!isNaN(u)?(e=p,n=u,console.log("WeatherFlow Card: Resolved primary station coordinate:",e,n)):console.warn("WeatherFlow Card: Parsed primary station coordinates are NaN:",d.latitude,d.longitude)}else console.warn("WeatherFlow Card: No primary station found in stations list:",l)}else console.warn("WeatherFlow Card: stationsAttr is not an array:",l)}else console.warn("WeatherFlow Card: stationsSensorId not found");if((this.lastRefLat!==e||this.lastRefLon!==n)&&(console.log("WeatherFlow Card: Reference coordinates changed from",this.lastRefLat,this.lastRefLon,"to",e,n),this.lastRefLat=e,this.lastRefLon=n,this.loadMapTexture(e,n),this.vectorDataLoaded=!1),this.config.show_3d_features&&!this.vectorDataLoading&&!this.vectorDataLoaded&&this.loadVectorData(e,n),s){const a=t.states[s].attributes.elevation_grid;a&&JSON.stringify(a)!==JSON.stringify(this.elevationGrid)&&this.updateTerrainGeometry(a);const l=t.states[s].attributes;this.windSpeed=l.wind_speed!==void 0?parseFloat(l.wind_speed):0,this.windDirection=l.wind_direction!==void 0?parseFloat(l.wind_direction):0,this.solarRadiation=l.solar_radiation!==void 0?parseFloat(l.solar_radiation):1e3,this.rainRate=l.rain_rate!==void 0?parseFloat(l.rain_rate):0,this.updateDayNightEngine(),this.updateWeatherOverlay();const d=l.stations;if(Array.isArray(d)){let p=!1;if(this.stations.length!==d.length)p=!0;else for(let u=0;u<d.length;u++)if(!this.stations.find(m=>m.id===d[u].id)){p=!0;break}if(console.log("WeatherFlow Card: Stations changed status:",p,"Current length:",this.stations.length,"New length:",d.length),p){const y=Math.cos(e*Math.PI/180);this.stations=d.map(m=>{const f=parseFloat(m.latitude),g=parseFloat(m.longitude),v=6371*(g-n)*(Math.PI/180)*y,E=-6371*(f-e)*(Math.PI/180);let x=6583435;return m.type==="primary"?x=1096065:m.type==="neighbor"&&(x=3718648),console.log("WeatherFlow Card: Mapped station:",m.id,"type:",m.type,"lat:",f,"lon:",g,"to grid coords:",v,E),{id:m.id,x:v,z:E,color:x,type:m.type}}),this.stationMeshes&&(console.log("WeatherFlow Card: Removing",this.stationMeshes.length,"old meshes"),this.stationMeshes.forEach(m=>{this.scene.remove(m.mesh)})),this.addWeatherStations()}}}const o="weatherflow_lightning_trilateration",h=Object.keys(t.states).filter(a=>a.startsWith("geo_location.")&&t.states[a].attributes.source===o),r=6371,c=Math.cos(e*Math.PI/180),i=[];h.forEach(a=>{const l=t.states[a],d=parseFloat(l.attributes.latitude),p=parseFloat(l.attributes.longitude);if(!isNaN(d)&&!isNaN(p)){const u=r*(p-n)*(Math.PI/180)*c,y=-r*(d-e)*(Math.PI/180),m=new Date(l.last_changed).getTime();i.push({id:a,time:m,x:u,z:y})}}),i.sort((a,l)=>a.time-l.time),i.forEach(a=>{if(!this.strikeHistory.some(l=>l.id===a.id)){const l=!this.knownStrikes.has(a.id);l&&this.knownStrikes.add(a.id);const d=this.playbackMode==="live"&&l;this.strikeHistory.push({id:a.id,time:a.time,x:a.x,z:a.z,animated:d||this.playbackMode!=="live"&&a.time<=this.playbackTime}),d&&this.triggerStrikeAnimation(a.x,a.z)}}),this.strikeHistory=this.strikeHistory.filter(a=>i.some(l=>l.id===a.id)),this.strikeHistory.sort((a,l)=>a.time-l.time);for(const a of this.knownStrikes)t.states[a]||this.knownStrikes.delete(a)}getCardSize(){return 3}}customElements.define("weatherflow-lightning-card",N),window.customCards=window.customCards||[],window.customCards.push({type:"weatherflow-lightning-card",name:"WeatherFlow Lightning Trilateration Card",description:"WebGL 3D visualizer showing real-time lightning strike trilaterations."});class O extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}setConfig(t){if(this._config=t,!this._initializedEditor)this.render(),this._initializedEditor=!0;else{const s=this.shadowRoot.getElementById("height");s&&(s.value=this._config.height||"350px");const e=this.shadowRoot.getElementById("zoom_level");e&&(e.value=this._config.zoom_level!==void 0?this._config.zoom_level:"18.0");const n=this.shadowRoot.getElementById("show_grid");n&&(n.checked=this._config.show_grid!==!1);const o=this.shadowRoot.getElementById("show_map");o&&(o.checked=this._config.show_map!==!1);const h=this.shadowRoot.getElementById("show_rings");h&&(h.checked=this._config.show_rings!==!1);const r=this.shadowRoot.getElementById("show_heatmap");r&&(r.checked=this._config.show_heatmap!==!1);const c=this.shadowRoot.getElementById("auto_orbit");c&&(c.checked=this._config.auto_orbit!==!1);const i=this.shadowRoot.getElementById("show_weather");i&&(i.checked=this._config.show_weather!==!1);const a=this.shadowRoot.getElementById("show_daynight");a&&(a.checked=this._config.show_daynight!==!1);const l=this.shadowRoot.getElementById("min_brightness");l&&(l.value=this._config.min_brightness!==void 0?this._config.min_brightness:"0.8");const d=this.shadowRoot.getElementById("elevation_scale");d&&(d.value=this._config.elevation_scale!==void 0?this._config.elevation_scale:"1.5");const p=this.shadowRoot.getElementById("show_3d_features");p&&(p.checked=this._config.show_3d_features===!0);const u=this.shadowRoot.getElementById("playback_speed");u&&(u.value=this._config.playback_speed!==void 0?this._config.playback_speed.toString():"120"),this._syncEntityPicker()}}set hass(t){this._hass=t,this._syncEntityPicker()}render(){if(!this._config)return;this.shadowRoot.innerHTML=`
      <style>
        .card-config {
          display: flex;
          flex-direction: column;
