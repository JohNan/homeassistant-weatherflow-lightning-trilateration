...
const Q=6371,J=111.1,tt=15,et=14,it=225,k=Math.floor(7),C=40,A=C/2,U=60,P=36e5,Y=9e4,Z=60,j=1e3/Z;class K extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.initialized=!1,this.knownStrikes=new Set,this.stations=[{id:"Primary (Home)",x:0,z:0,color:1096065},{id:"Neighbor 1",x:10,z:10,color:3718648},{id:"Neighbor 2",x:-10,z:10,color:3718648}],this.strikeLayer=null,this.strikeHistory=[],this.isPlaying=!1,this.playbackMode="live",this.playbackTime=Date.now(),this.playbackSpeed=120,this.lastPlayTickTime=Date.now(),this.lastInteractionTime=Date.now(),this.heatmapMeshes=new Map,this.elevationGrid=[],this.glowTexture=null,this.heatGeo=null,this.lastRefLat=null,this.lastRefLon=null,this.windSpeed=0,this.windDirection=0,this.solarRadiation=1e3,this.rainRate=0,this.rainParticles=null,this.windParticles=null,this.lastFrameTime=null,this.showHeightColor=!0,this._activeRafIds=new Set,this._warnedKeys=new Set}static getConfigElement(){return document.createElement("weatherflow-lightning-card-editor")}static getStubConfig(){return{height:"350px"}}setConfig(t){if(!t)throw new Error("Invalid configuration");const e=this.config;if(this.config={height:"350px",show_grid:!0,show_map:!0,show_rings:!0,show_heatmap:!0,auto_orbit:!0,zoom_level:18,show_weather:!0,show_daynight:!0,min_brightness:.8,elevation_scale:1.5,show_3d_features:!1,playback_speed:120,show_height_color:!0,...t},this.playbackSpeed=parseFloat(this.config.playback_speed)||120,this.speedSelect&&(this.speedSelect.value=this.playbackSpeed.toString()),this.container){const i=String(this.config.height);if(i.endsWith("px")){const a=parseInt(i);this.container.style.height=`${a-40}px`}else this.container.style.height=i}this.initialized&&this.applyConfigChanges(e||{})}applyConfigChanges(t){if(this.terrainWire&&(this.terrainWire.visible=this.config.show_grid!==!1),this.rangeRingsGroup&&(this.rangeRingsGroup.visible=this.config.show_rings!==!1),this.config.show_weather===!1?(this.rainParticles&&(this.rainParticles.visible=!1),this.windParticles&&(this.windParticles.visible=!1),this.weatherOverlay&&(this.weatherOverlay.style.display="none")):this.weatherOverlay&&(this.weatherOverlay.style.display="flex"),t.show_map!==this.config.show_map&&(this.config.show_map?this.lastRefLat&&this.lastRefLon&&this.loadMapTexture(this.lastRefLat,this.lastRefLon):this.terrainMesh&&this.terrainMesh.material&&(this.terrainMesh.material.map=null,this.terrainMesh.material.color.setHex(330516),this.terrainMesh.material.needsUpdate=!0)),(t.show_daynight!==this.config.show_daynight||t.min_brightness!==this.config.min_brightness)&&this.updateDayNightEngine(),t.zoom_level!==this.config.zoom_level){const e=parseFloat(this.config.zoom_level);isNaN(e)||(this.zoomRadius=e,this.updateCameraPosition())}t.elevation_scale!==this.config.elevation_scale&&(this.elevationGrid&&this.elevationGrid.length===225?this.updateTerrainGeometry(this.elevationGrid):this.generateProceduralTerrain()),t.show_3d_features!==this.config.show_3d_features&&(this.config.show_3d_features?this.lastRefLat&&this.lastRefLon&&this.loadVectorData(this.lastRefLat,this.lastRefLon):(this.features3DGroup&&(this.scene.remove(this.features3DGroup),this.features3DGroup=null),this.vectorDataLoaded=!1))}connectedCallback(){if(window.THREE){this.initVisualizer();return}if(this._threeScriptLoading)return;this._threeScriptLoading=!0;const t=document.createElement("script");t.src="/weatherflow_lightning_trilateration/three.min.js",t.onload=()=>{this._threeScriptLoading=!1,this.initVisualizer()},t.onerror=e=>{this._threeScriptLoading=!1,console.error("WeatherFlow Card: Failed to load three.min.js",e)},document.head.appendChild(t)}disconnectedCallback(){this.cleanupThreeJS()}cleanupThreeJS(){if(this.isPlaying=!1,this.animationFrameId&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this._activeRafIds&&(this._activeRafIds.forEach(t=>cancelAnimationFrame(t)),this._activeRafIds.clear()),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this._mouseupHandler&&(window.removeEventListener("mouseup",this._mouseupHandler),this._mouseupHandler=null),this.features3DGroup&&(this.scene.remove(this.features3DGroup),this.disposeHierarchy(this.features3DGroup),this.features3DGroup=null),this.stationMeshes&&(this.stationMeshes.forEach(t=>{this.scene.remove(t.mesh),this.disposeHierarchy(t.mesh)}),this.stationMeshes=[]),this.heatmapMeshes){for(const t of this.heatmapMeshes.values())this.scene.remove(t.mesh),t.material&&t.material.dispose();this.heatmapMeshes.clear()}this.rangeRingsGroup&&(this.scene.remove(this.rangeRingsGroup),this.disposeHierarchy(this.rangeRingsGroup),this.rangeRingsGroup=null),this.strikeLayer&&(this.scene.remove(this.strikeLayer),this.disposeHierarchy(this.strikeLayer),this.strikeLayer=null),this.terrainMapMesh&&(this.scene.remove(this.terrainMapMesh),this.terrainMapMesh.geometry&&this.terrainMapMesh.geometry.dispose(),this.terrainMapMesh.material&&(this.terrainMapMesh.material.map&&this.terrainMapMesh.material.map.dispose(),this.terrainMapMesh.material.dispose())),this.terrainMesh&&(this.scene.remove(this.terrainMesh),this.terrainMesh.geometry&&this.terrainMesh.geometry.dispose(),this.terrainMesh.material&&this.terrainMesh.material.dispose()),this.terrainWire&&(this.scene.remove(this.terrainWire),this.terrainWire.geometry&&this.terrainWire.geometry.dispose(),this.terrainWire.material&&this.terrainWire.material.dispose()),this.starField&&(this.scene.remove(this.starField),this.starField.geometry&&this.starField.geometry.dispose(),this.starField.material&&this.starField.material.dispose()),this.cloudGroup&&(this.disposeHierarchy(this.cloudGroup),this.scene.remove(this.cloudGroup),this.cloudGroup=null),this._skyDome&&(this.scene.remove(this._skyDome),this._skyDome.geometry&&this._skyDome.geometry.dispose(),this._skyDome.material&&this._skyDome.material.dispose(),this._skyDome=null),this._skyTexture&&(this._skyTexture.dispose(),this._skyTexture=null),this._skyCanvas=null,this.rainParticles&&(this.scene.remove(this.rainParticles),this.rainParticles.geometry&&this.rainParticles.geometry.dispose(),this.rainParticles.material&&this.rainParticles.material.dispose()),this.windParticles&&(this.scene.remove(this.windParticles),this.windParticles.geometry&&this.windParticles.geometry.dispose(),this.windParticles.material&&this.windParticles.material.dispose()),this.heatGeo&&this.heatGeo.dispose(),this.glowTexture&&this.glowTexture.dispose(),this.ambientLight&&this.scene.remove(this.ambientLight),this.dirLight&&this.scene.remove(this.dirLight),this.renderer&&(this.renderer.domElement&&this.renderer.domElement.parentNode&&this.renderer.domElement.parentNode.removeChild(this.renderer.domElement),this.renderer.dispose(),this.renderer=null),this.wrapper&&this.wrapper.parentNode&&(this.wrapper.parentNode.removeChild(this.wrapper),this.wrapper=null),this.initialized=!1}disposeHierarchy(t){t&&t.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material:[e.material]).forEach(a=>{a.map&&a.map.dispose(),a.dispose()})})}updateCameraPosition(){this.cameraPhi=Math.max(.1,Math.min(Math.PI/2-.05,this.cameraPhi)),this.zoomRadius=Math.max(2,Math.min(150,this.zoomRadius)),this.cameraTarget||(this.cameraTarget=new THREE.Vector3(0,0,0));const t=this.zoomRadius*Math.sin(this.cameraPhi)*Math.sin(this.cameraTheta),e=this.zoomRadius*Math.cos(this.cameraPhi),i=this.zoomRadius*Math.sin(this.cameraPhi)*Math.cos(this.cameraTheta);this.camera&&(this.camera.position.set(this.cameraTarget.x+t,this.cameraTarget.y+e,this.cameraTarget.z+i),this.camera.lookAt(this.cameraTarget))}initVisualizer(){if(this.initialized)return;this.initialized=!0,this.wrapper=document.createElement("div"),this.wrapper.style.position="relative",this.wrapper.style.width="100%",this.wrapper.style.display="flex",this.wrapper.style.flexDirection="column",this.wrapper.style.backgroundColor="#02040a",this.wrapper.style.borderRadius="12px",this.wrapper.style.overflow="hidden",this.wrapper.style.border="1px solid rgba(56, 189, 248, 0.15)",this.shadowRoot.appendChild(this.wrapper),this.container=document.createElement("div"),this.container.style.position="relative",this.container.style.width="100%";const t=String(this.config.height||"350px");if(t.endsWith("px")){const s=parseInt(t);this.container.style.height=`${s-40}px`}else this.container.style.height=t;this.container.style.overflow="hidden",this.container.style.cursor="grab",this.container.style.userSelect="none",this.container.style.webkitUserSelect="none",this.container.style.touchAction="none",this.wrapper.appendChild(this.container),this.createPlaybackControls(),this.scene=new THREE.Scene,this.scene.fog=new THREE.FogExp2(132106,.005);const e=this.container.clientWidth/this.container.clientHeight;this.camera=new THREE.PerspectiveCamera(60,e,.1,1e3),this.zoomRadius=this.config.zoom_level!==void 0?parseFloat(this.config.zoom_level):18,this.cameraTheta=0,this.cameraPhi=Math.PI/4,this.cameraTarget=new THREE.Vector3(0,0,0),this.updateCameraPosition(),this.renderer=new THREE.WebGLRenderer({antialias:!0}),this.renderer.setSize(this.container.clientWidth,this.container.clientHeight),this.renderer.setClearColor(132106,1),this.renderer.setPixelRatio(window.devicePixelRatio||1),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=THREE.PCFSoftShadowMap,this.renderer.toneMapping=THREE.ACESFilmicToneMapping,this.renderer.toneMappingExposure=1,this.container.appendChild(this.renderer.domElement),this.tooltip=document.createElement("div"),this.tooltip.style.position="absolute",this.tooltip.style.backgroundColor="rgba(8, 12, 20, 0.95)",this.tooltip.style.color="#e2e8f0",this.tooltip.style.padding="8px 12px",this.tooltip.style.borderRadius="6px",this.tooltip.style.border="1px solid rgba(56, 189, 248, 0.4)",this.tooltip.style.fontSize="12px",this.tooltip.style.pointerEvents="none",this.tooltip.style.display="none",this.tooltip.style.zIndex="10",this.tooltip.style.fontFamily="sans-serif",this.tooltip.style.boxShadow="0 4px 12px rgba(0, 0, 0, 0.5)",this.container.appendChild(this.tooltip);const i=document.createElement("style");i.textContent=`
    ...
    `,this.container.appendChild(i),this.weatherOverlay=document.createElement("div"),this.weatherOverlay.className="weather-telemetry-hud",this.weatherOverlay.style.display=this.config.show_weather!==!1?"flex":"none",this.container.appendChild(this.weatherOverlay),this.hudCollapsed=!1;const a=s=>s.stopPropagation();["mousedown","mousemove","mouseup","click","touchstart","touchmove","touchend","wheel"].forEach(s=>{this.weatherOverlay.addEventListener(s,a)}),this.weatherOverlay.addEventListener("click",s=>{if(s.target.closest(".hud-color-btn")){s.stopPropagation(),this.showHeightColor=!this.showHeightColor,this._paintHypsometricColours(),this.updateWeatherOverlay();return}(s.target.closest(".hud-toggle-btn")||this.hudCollapsed)&&(s.stopPropagation(),this.hudCollapsed=!this.hudCollapsed,this.hudCollapsed?(this.weatherOverlay.classList.add("collapsed"),this.weatherOverlay.title="Expand Weather HUD"):(this.weatherOverlay.classList.remove("collapsed"),this.weatherOverlay.removeAttribute("title")),this.updateWeatherOverlay())}),this.raycaster=new THREE.Raycaster,this.mouse=new THREE.Vector2,this.glowTexture=this.createGlowTexture(),this.heatGeo=new THREE.SphereGeometry(.15,8,8),this.lastInteractionTime=Date.now();let n=!1,l=!1,h={x:0,y:0};this.container.addEventListener("contextmenu",s=>{s.preventDefault()}),this.container.addEventListener("mousedown",s=>{this.lastInteractionTime=Date.now(),s.button===2||s.button===1||s.shiftKey?(l=!0,n=!1,this.container.style.cursor="move"):(n=!0,l=!1,this.container.style.cursor="grabbing"),h={x:s.clientX,y:s.clientY}}),this.container.addEventListener("mousemove",s=>{if(this.lastInteractionTime=Date.now(),n){const r=s.clientX-h.x,u=s.clientY-h.y;this.cameraTheta-=r*.005,this.cameraPhi+=u*.005,this.updateCameraPosition(),h={x:s.clientX,y:s.clientY}}else if(l){const r=s.clientX-h.x,u=s.clientY-h.y,d=new THREE.Vector3(1,0,0).applyQuaternion(this.camera.quaternion),m=new THREE.Vector3(0,1,0).applyQuaternion(this.camera.quaternion),w=this.zoomRadius*.0015;this.cameraTarget.addScaledVector(d,-r*w),this.cameraTarget.addScaledVector(m,u*w),this.cameraTarget.x=Math.max(-30,Math.min(30,this.cameraTarget.x)),this.cameraTarget.y=Math.max(-5,Math.min(15,this.cameraTarget.y)),this.cameraTarget.z=Math.max(-30,Math.min(30,this.cameraTarget.z)),this.updateCameraPosition(),h={x:s.clientX,y:s.clientY}}else{const r=this.renderer.domElement.getBoundingClientRect();this.mouse.x=(s.clientX-r.left)/r.width*2-1,this.mouse.y=-((s.clientY-r.top)/r.height)*2+1,this.checkHover(s.clientX-r.left,s.clientY-r.top)}}),this._mouseupHandler=()=>{n=!1,l=!1,this.container.style.cursor="grab"},window.addEventListener("mouseup",this._mouseupHandler),this.container.addEventListener("mouseleave",()=>{this.hideTooltip()}),this.container.addEventListener("wheel",s=>{this.lastInteractionTime=Date.now(),this.hideTooltip(),s.preventDefault(),this.zoomRadius+=s.deltaY*.02,this.updateCameraPosition()},{passive:!1});let c=0;this.container.addEventListener("touchstart",s=>{this.lastInteractionTime=Date.now(),this.hideTooltip(),s.touches.length===1?(n=!0,h={x:s.touches[0].clientX,y:s.touches[0].clientY}):s.touches.length===2&&(n=!1,c=Math.hypot(s.touches[0].clientX-s.touches[1].clientX,s.touches[0].clientY-s.touches[1].clientY))}),this.container.addEventListener("touchmove",s=>{if(this.lastInteractionTime=Date.now(),s.preventDefault(),s.touches.length===1&&n){const r=s.touches[0].clientX-h.x,u=s.touches[0].clientY-h.y;this.cameraTheta-=r*.007,this.cameraPhi+=u*.007,this.updateCameraPosition(),h={x:s.touches[0].clientX,y:s.touches[0].clientY}}else if(s.touches.length===2){const r=Math.hypot(s.touches[0].clientX-s.touches[1].clientX,s.touches[0].clientY-s.touches[1].clientY),u=r-c;this.zoomRadius-=u*.15,this.updateCameraPosition(),c=r}},{passive:!1}),this.container.addEventListener("touchend",()=>{n=!1}),this.addStaticElements(),this.initWeatherSystem(),this.updateDayNightEngine(),this.addWeatherStations(),this.generateProceduralTerrain(),this.strikeLayer=new THREE.Group,this.scene.add(this.strikeLayer),this.resizeObserver=new ResizeObserver(()=>{if(this.renderer&&this.container){const s=this.container.clientWidth,r=this.container.clientHeight;this.camera.aspect=s/r,this.camera.updateProjectionMatrix(),this.renderer.setSize(s,r)}}),this.resizeObserver.observe(this.container),this.animateLoop(),this._hass&&(console.log("WeatherFlow Card: Re-applying cached state on init completion"),this.hass=this._hass)}createGlowTexture(){const t=document.createElement("canvas");t.width=64,t.height=64;const e=t.getContext("2d"),i=new THREE.CanvasTexture(t);if(!e)return i;const a=e.createRadialGradient(32,32,0,32,32,32);return a.addColorStop(0,"rgba(0, 242, 254, 1.0)"),a.addColorStop(.2,"rgba(0, 242, 254, 0.8)"),a.addColorStop(.5,"rgba(239, 68, 68, 0.3)"),a.addColorStop(1,"rgba(0, 0, 0, 0)"),e.fillStyle=a,e.fillRect(0,0,64,64),i.needsUpdate=!0,i}createRingLabelSprite(t){const e=document.createElement("canvas");e.width=128,e.height=64;const i=e.getContext("2d");if(!i){const l=new THREE.CanvasTexture(e),h=new THREE.SpriteMaterial({map:l,transparent:!0,depthWrite:!1}),c=new THREE.Sprite(h);return c.scale.set(2,1,1),c}i.fillStyle="rgba(0, 0, 0, 0)",i.fillRect(0,0,128,64),i.font="bold 24px sans-serif",i.fillStyle="#00f2fe",i.textAlign="center",i.textBaseline="middle",i.fillText(t,64,32);const a=new THREE.CanvasTexture(e),o=new THREE.SpriteMaterial({map:a,transparent:!0,depthWrite:!1,depthTest:!0}),n=new THREE.Sprite(o);return n.scale.set(2,1,1),n}addRangeRings(){this.rangeRingsGroup=new THREE.Group,this.rangeRingsGroup.visible=this.config.show_rings!==!1,this.scene.add(this.rangeRingsGroup);const t=[10,20,30];t.forEach(r=>{const u=[];for(let g=0;g<=128;g++){const f=g/128*Math.PI*2,p=r*Math.cos(f),E=r*Math.sin(f),b=this.getTerrainHeight(p,E)+.15;u.push(new THREE.Vector3(p,b,E))}const m=new THREE.BufferGeometry().setFromPoints(u),w=new THREE.LineBasicMaterial({color:62206,transparent:!0,opacity:.5,polygonOffset:!0,polygonOffsetFactor:-4,polygonOffsetUnits:-4}),y=new THREE.Line(m,w);this.rangeRingsGroup.add(y)});const e=new THREE.LineBasicMaterial({color:62206,transparent:!0,opacity:.3,polygonOffset:!0,polygonOffsetFactor:-4,polygonOffsetUnits:-4}),i=[],a=40;for(let r=0;r<=a;r++){const u=-30+r/a*60,d=this.getTerrainHeight(0,u)+.15;i.push(new THREE.Vector3(0,d,u))}const o=new THREE.BufferGeometry().setFromPoints(i),n=new THREE.Line(o,e);this.rangeRingsGroup.add(n);const l=[];for(let r=0;r<=a;r++){const u=-30+r/a*60,d=this.getTerrainHeight(u,0)+.15;l.push(new THREE.Vector3(u,d,0))}const h=new THREE.BufferGeometry().setFromPoints(l),c=new THREE.Line(h,e);this.rangeRingsGroup.add(c);const s=Math.SQRT2/2;this.ringLabels=[],t.forEach(r=>{const u=this.createRingLabelSprite(`${r}km`);u.position.set(r*s,.5,-r*s),this.rangeRingsGroup.add(u),this.ringLabels.push({sprite:u,r})})}updateRangeRings(){if(!this.rangeRingsGroup||!this.rangeRingsGroup.children)return;const t=this.rangeRingsGroup.children;[10,20,30].forEach((n,l)=>{const h=t[l];if(h){const c=h.geometry.attributes.position,s=128;for(let r=0;r<=s;r++){const u=r/s*Math.PI*2,d=n*Math.cos(u),m=n*Math.sin(u),w=this.getTerrainHeight(d,m)+.15;c.setY(r,w)}c.needsUpdate=!0}});const i=t[3];if(i){const n=i.geometry.attributes.position,l=40;for(let h=0;h<=l;h++){const c=-30+h/l*60,s=this.getTerrainHeight(0,c)+.15;n.setXYZ(h,0,s,c)}n.needsUpdate=!0}const a=t[4];if(a){const n=a.geometry.attributes.position,l=40;for(let h=0;h<=l;h++){const c=-30+h/l*60,s=this.getTerrainHeight(c,0)+.15;n.setXYZ(h,c,s,0)}n.needsUpdate=!0}const o=Math.SQRT2/2;this.ringLabels&&this.ringLabels.forEach(n=>{const l=n.r*o,h=-n.r*o,c=this.getTerrainHeight(l,h)+.4;n.sprite.position.set(l,c,h)})}getTerrainHeight(t,e){if(!this.elevationGrid||this.elevationGrid.length!==225)return 0;const i=(t+A)*14/C,a=(e+A)*14/C;if(i<0||i>14||a<0||a>14)return 0;const o=Math.floor(i),n=Math.min(14,o+1),l=Math.floor(a),h=Math.min(14,l+1),c=i-o,s=a-l,r=this.getGridHeight(l,o),u=this.getGridHeight(l,n),d=this.getGridHeight(h,o),m=this.getGridHeight(h,n),w=r*(1-c)+u*c,y=d*(1-c)+m*c;return w*(1-s)+y*s}getGridHeight(t,e){return this.scaledHeights?this.scaledHeights[(14-t)*15+e]:0}generateProceduralTerrain(){this.elevationGrid=[];for(let n=0;n<15;n++){const l=n-k;for(let h=0;h<15;h++){const c=h-k,s=Math.sqrt(l*l+c*c);let r=80+Math.sin(l*.4)*Math.cos(c*.4)*45;if(r+=Math.sin(s*.8)*15,n===k&&h===k)r=100;else{const u=Math.min(1,s/3);r=100*(1-u)+r*u}this.elevationGrid.push(r)}}const t=100,i=(this.config.elevation_scale!==void 0?parseFloat(this.config.elevation_scale):1.5)/1e3;this.scaledHeights=new Float32Array(225);for(let n=0;n<225;n++)this.scaledHeights[n]=((this.elevationGrid[n]||0)-t)*i;const a=this.terrainGeo.attributes.position,o=a.count;for(let n=0;n<o;n++){const l=a.getX(n),h=a.getY(n),c=this.getTerrainHeight(l,-h);a.setZ(n,c)}a.needsUpdate=!0,this.terrainGeo.computeVertexNormals(),this._paintHypsometricColours(),this.updateStationHeights(),this.updateRangeRings()}loadMapTexture(t,e){if(this.config.show_map===!1){this.terrainMapMesh&&(this.terrainMapMesh.visible=!1);return}this.terrainMapMesh&&(this.terrainMapMesh.visible=!0);const i=12,a=C,o=a/111.1,n=Math.cos(t*Math.PI/180),l=n>0?a/(111.1*n):a/111.1,h=t-o/2,c=t+o/2,s=e-l/2,r=e+l/2,u=(M,x)=>(M+180)/360*Math.pow(2,x),d=(M,x)=>(1-Math.log(Math.tan(M*Math.PI/180)+1/Math.cos(M*Math.PI/180))/Math.PI)/2*Math.pow(2,x),m=(M,x)=>M/Math.pow(2,x)*360-180,w=(M,x)=>Math.atan(Math.sinh(Math.PI-2*Math.PI*M/Math.pow(2,x)))*180/Math.PI,y=Math.floor(u(s,i)),g=Math.floor(u(r,i)),f=Math.floor(d(c,i)),p=Math.floor(d(h,i)),E=2048,b=document.createElement("canvas");b.width=E,b.height=E;const v=b.getContext("2d");if(!v)return;v.fillStyle="#050b14",v.fillRect(0,0,E,E);const _=[];for(let M=y;M<=g;M++)for(let x=f;x<=p;x++){const R=m(M,i),H=m(M+1,i),T=w(x+1,i),S=w(x,i),L=(R-s)/(r-s),F=(H-s)/(r-s),O=(T-h)/(c-h),G=(S-h)/(c-h),N=L*E,B=(1-G)*E,V=(F-L)*E,W=(G-O)*E,X=`https://basemaps.cartocdn.com/dark_all/${i}/${M}/${x}.png`,$=new Promise(D=>{const I=new Image;I.crossOrigin="anonymous",I.onload=()=>{v.drawImage(I,N,B,V,W),D()},I.onerror=()=>D(),I.src=X});_.push($)}Promise.all(_).then(()=>{const M=new THREE.CanvasTexture(b);this.terrainMapMesh&&this.terrainMapMesh.material?(this.terrainMapMesh.material.map&&this.terrainMapMesh.material.map.dispose(),this.terrainMapMesh.material.map=M,this.terrainMapMesh.material.color.setHex(16777215),this.terrainMapMesh.material.needsUpdate=!0):M.dispose()})}async loadVectorData(t,e){this.vectorDataLoading=!0;try{const i=await this._hass.callApi("GET","weatherflow_lightning/vector_data");this.render3DFeatures(i,t,e),this.vectorDataLoaded=!0}catch(i){console.error("Failed to load 3D vector features:",i)}finally{this.vectorDataLoading=!1}}_latLonToGrid(t,e,i,a){const o=Math.cos(i*Math.PI/180),n=6371*(e-a)*(Math.PI/180)*o,l=-6371*(t-i)*(Math.PI/180);return{x:n,z:l}}render3DFeatures(t,e,i){if(this.scene){if(this.features3DGroup&&(this.scene.remove(this.features3DGroup),this.disposeHierarchy(this.features3DGroup)),this.features3DGroup=new THREE.Group,this.scene.add(this.features3DGroup),t.water&&Array.isArray(t.water)){const a=new THREE.MeshPhongMaterial({color:165063,transparent:!0,opacity:.5,side:THREE.DoubleSide,flatShading:!0});t.water.forEach(o=>{if(!o.coordinates||o.coordinates.length<3)return;const n=[];let l=0,h=0;if(o.coordinates.forEach(u=>{const d=u[0],m=u[1],{x:w,z:y}=this._latLonToGrid(d,m,e,i);w<-20||w>20||y<-20||y>20||(n.push(new THREE.Vector2(w,-y)),l+=this.getTerrainHeight(w,y),h++)}),n.length<3)return;l/=h;const c=new THREE.Shape(n),s=new THREE.ShapeGeometry(c),r=new THREE.Mesh(s,a);r.rotation.x=-Math.PI/2,r.position.y=l+.08,this.features3DGroup.add(r)})}if(t.forest&&Array.isArray(t.forest)){const a=[],o=new THREE.MeshPhongMaterial({color:1332013,transparent:!0,opacity:.45,side:THREE.DoubleSide,flatShading:!0}),n=[],l=[],h=[];let c=0;const s=1500,r=(y,g)=>{const f=y[0],p=y[1];let E=!1;for(let b=0,v=g.length-1;b<g.length;v=b++){const _=g[b][0],M=g[b][1],x=g[v][0],R=g[v][1];M>p!=R>p&&f<(x-_)*(p-M)/(R-M)+_&&(E=!E)}return E};t.forest.forEach(y=>{if(!y.coordinates||y.coordinates.length<3)return;const g=[];let f=0,p=0;const E=y.coordinates.map(b=>{const v=b[0],_=b[1],{x:M,z:x}=this._latLonToGrid(v,_,e,i);return M>=-20&&M<=20&&x>=-20&&x<=20&&(g.push(new THREE.Vector2(M,-x)),f+=this.getTerrainHeight(M,x),p++),[M,x]});if(a.push(E),g.length>=3){f/=p;const b=new THREE.Shape(g),v=new THREE.ShapeGeometry(b),_=new THREE.Mesh(v,o);_.rotation.x=-Math.PI/2,_.position.y=f+.06,this.features3DGroup.add(_)}if(E.length>0&&c<s){let b=0,v=0;E.forEach(L=>{b+=L[0],v+=L[1]});const _=Math.max(-19.5,Math.min(19.5,b/E.length)),M=Math.max(-19.5,Math.min(19.5,v/E.length)),x=this.getTerrainHeight(_,M),R=.85+Math.random()*.4,H=Math.random()*Math.PI*2,T=new THREE.Object3D;T.position.set(_,x,M),T.rotation.y=H,T.scale.set(R,R,R),T.updateMatrix();const S=Math.random();S<.33?n.push(T.matrix.clone()):S<.66?l.push(T.matrix.clone()):h.push(T.matrix.clone()),c++}});const u=.45,d=u*.35,m=y=>{for(const g of a)if(r(y,g))return!0;return!1};for(let y=-19.5;y<=19.5;y+=u)for(let g=-19.5;g<=19.5&&!(c>=s);g+=u){const f=y+(Math.random()*2-1)*d,p=g+(Math.random()*2-1)*d,E=Math.max(-19.5,Math.min(19.5,f)),b=Math.max(-19.5,Math.min(19.5,p));if(m([E,b])){const v=this.getTerrainHeight(E,b),_=.85+Math.random()*.4,M=Math.random()*Math.PI*2,x=new THREE.Object3D;x.position.set(E,v,b),x.rotation.y=M,x.scale.set(_,_,_),x.updateMatrix();const R=Math.random();R<.33?n.push(x.matrix.clone()):R<.66?l.push(x.matrix.clone()):h.push(x.matrix.clone()),c++}}const w=(y,g,f,p,E)=>{if(y.length===0)return;const b=new THREE.InstancedMesh(g,f,y.length);y.forEach((v,_)=>b.setMatrixAt(_,v)),b.instanceMatrix.needsUpdate=!0,this.features3DGroup.add(b);for(let v=0;v<p.length;v++){const _=new THREE.InstancedMesh(p[v],E[v],y.length);y.forEach((M,x)=>_.setMatrixAt(x,M)),_.instanceMatrix.needsUpdate=!0,this.features3DGroup.add(_)}};if(n.length>0){const y=new THREE.CylinderGeometry(.04,.04,.2,4);y.translate(0,.1,0);const g=new THREE.MeshPhongMaterial({color:4007959,flatShading:!0}),f=new THREE.MeshPhongMaterial({color:998171,flatShading:!0}),p=[new THREE.ConeGeometry(.18,.3,5).translate(0,.3,0),new THREE.ConeGeometry(.14,.25,5).translate(0,.45,0),new THREE.ConeGeometry(.1,.2,5).translate(0,.6,0)];w(n,y,g,p,[f,f,f])}if(l.length>0){const y=new THREE.CylinderGeometry(.06,.08,.25,5);y.translate(0,.125,0);const g=new THREE.MeshPhongMaterial({color:6045747,flatShading:!0}),f=new THREE.MeshPhongMaterial({color:2263842,flatShading:!0}),p=[new THREE.SphereGeometry(.18,6,6).translate(-.05,.3,0),new THREE.SphereGeometry(.2,6,6).translate(.05,.35,0)];w(l,y,g,p,[f,f])}if(h.length>0){const y=new THREE.CylinderGeometry(.03,.03,.3,4);y.translate(0,.15,0);const g=new THREE.MeshPhongMaterial({color:13882323,flatShading:!0}),f=new THREE.MeshPhongMaterial({color:9498256,flatShading:!0}),p=new THREE.SphereGeometry(.15,6,6);p.scale(1,1.8,1),p.translate(0,.4,0),w(h,y,g,[p],[f])}}if(t.road&&Array.isArray(t.road)){const a=new THREE.LineBasicMaterial({color:4674921,transparent:!0,opacity:.6});t.road.forEach(o=>{if(!o.coordinates||o.coordinates.length<2)return;const n=[];if(o.coordinates.forEach(c=>{const s=c[0],r=c[1],{x:u,z:d}=this._latLonToGrid(s,r,e,i);if(u<-20||u>20||d<-20||d>20)return;const m=this.getTerrainHeight(u,d)+.02;n.push(new THREE.Vector3(u,m,d))}),n.length<2)return;const l=new THREE.BufferGeometry().setFromPoints(n),h=new THREE.Line(l,a);this.features3DGroup.add(h)})}if(t.building&&Array.isArray(t.building)){const a=new THREE.MeshPhongMaterial({color:1976635,transparent:!0,opacity:.7,flatShading:!0});t.building.forEach(o=>{if(!o.coordinates||o.coordinates.length<3)return;const n=[];let l=0,h=0,c=0;if(o.coordinates.forEach(f=>{const p=f[0],E=f[1],{x:b,z:v}=this._latLonToGrid(p,E,e,i);b<-20||b>20||v<-20||v>20||(n.push(new THREE.Vector2(b,-v)),l+=b,h+=v,c++)}),n.length<3)return;l/=c,h/=c;const s=this.getTerrainHeight(l,h),r=(this.config.elevation_scale!==void 0?parseFloat(this.config.elevation_scale):1.5)/1e3,d=(o.height!==void 0?o.height:8)*r,m=new THREE.Shape(n),w={depth:d,bevelEnabled:!1},y=new THREE.ExtrudeGeometry(m,w),g=new THREE.Mesh(y,a);g.rotation.x=-Math.PI/2,g.position.y=s,g.castShadow=!0,g.receiveShadow=!0,this.features3DGroup.add(g)})}}}_paintHypsometricColours(){if(!this.scaledHeights||!this.terrainGeo)return;let t=1/0,e=-1/0;for(let s=0;s<225;s++)this.scaledHeights[s]<t&&(t=this.scaledHeights[s]),this.scaledHeights[s]>e&&(e=this.scaledHeights[s]);const i=e-t||1,a=[{t:0,r:.05,g:.15,b:.05},{t:.35,r:.12,g:.28,b:.08},{t:.55,r:.3,g:.22,b:.08},{t:.75,r:.45,g:.3,b:.18},{t:1,r:.82,g:.8,b:.78}],o=s=>{let r=a[0],u=a[a.length-1];for(let m=0;m<a.length-1;m++)if(s>=a[m].t&&s<=a[m+1].t){r=a[m],u=a[m+1];break}const d=u.t===r.t?0:(s-r.t)/(u.t-r.t);return{r:r.r+(u.r-r.r)*d,g:r.g+(u.g-r.g)*d,b:r.b+(u.b-r.b)*d}},n=this.terrainGeo.attributes.position,l=this.terrainGeo.attributes.color;if(!l)return;const h=n.count,c=this.showHeightColor!==!1;for(let s=0;s<h;s++)if(!c)l.setXYZ(s,.02,.02,.02);else{const r=n.getX(s),u=n.getY(s),m=(this.getTerrainHeight(r,-u)-t)/i,w=o(Math.max(0,Math.min(1,m)));l.setXYZ(s,w.r,w.g,w.b)}l.needsUpdate=!0}updateTerrainGeometry(t){if(!t||t.length!==225){this.generateProceduralTerrain();return}this.elevationGrid=t;const e=k*15+k,i=t[e]||0,o=(this.config.elevation_scale!==void 0?parseFloat(this.config.elevation_scale):1.5)/1e3;this.scaledHeights=new Float32Array(225);for(let h=0;h<225;h++)this.scaledHeights[h]=((t[h]||0)-i)*o;const n=this.terrainGeo.attributes.position,l=n.count;for(let h=0;h<l;h++){const c=n.getX(h),s=n.getY(h),r=this.getTerrainHeight(c,-s);n.setZ(h,r)}n.needsUpdate=!0,this.terrainGeo.computeVertexNormals(),this._paintHypsometricColours(),this.updateStationHeights(),this.updateRangeRings()}updateStationHeights(){!this.stationMeshes||!this.stations||this.stations.forEach((t,e)=>{const i=this.stationMeshes[e];if(i&&i.mesh){const a=this.getTerrainHeight(t.x,t.z);i.mesh.position.y=a}})}showTooltip(t,e,i){if(!this.tooltip)return;let a="Discovered Station";t.type==="primary"?a="Primary Station":t.type==="neighbor"&&(a="Neighbor Station"),this.tooltip.innerHTML=`
    ...
    `,this.tooltip.style.display="block";const o=this.container.getBoundingClientRect();let n=e+15,l=i+15;n+150>o.width&&(n=e-165),l+60>o.height&&(l=i-75),this.tooltip.style.left=`${n}px`,this.tooltip.style.top=`${l}px`}hideTooltip(){this.tooltip&&(this.tooltip.style.display="none")}checkHover(t,e){if(!this.camera||!this.stationMeshes||!this.raycaster)return;this.raycaster.setFromCamera(this.mouse,this.camera);const i=this.raycaster.intersectObjects(this.stationMeshes.map(a=>a.mesh),!0);if(i.length>0){let a=i[0].object;for(;a&&a.parent&&(!a.userData||!a.userData.station);)a=a.parent;if(a&&a.userData&&a.userData.station){const o=a.userData.station;this.showTooltip(o,t,e),this.container.style.cursor="pointer";return}}this.hideTooltip(),this.container.style.cursor==="pointer"&&(this.container.style.cursor="grab")}updateHeatmap(){if(!this.scene)return;const t=Y,e=this.playbackTime;this.heatmapMeshes||(this.heatmapMeshes=new Map);const i=new Set;for(let a=0;a<this.strikeHistory.length;a++){const o=this.strikeHistory[a],n=e-o.time;if(n>=0&&n<=t){i.add(o.id);const l=n/t,h=.7*(1-l),c=1-l*.4;let s=this.heatmapMeshes.get(o.id);if(s)s.material.opacity=h,s.mesh.scale.set(c,c,c),s.mesh.position.y=this.getTerrainHeight(o.x,o.z);else{const r=new THREE.MeshBasicMaterial({color:16096779,transparent:!0,opacity:h,depthWrite:!1}),u=new THREE.Mesh(this.heatGeo,r),d=this.getTerrainHeight(o.x,o.z);u.position.set(o.x,d,o.z),u.scale.set(c,c,c),this.scene.add(u),s={mesh:u,material:r},this.heatmapMeshes.set(o.id,s)}}}for(const[a,o]of this.heatmapMeshes.entries())i.has(a)||(this.scene.remove(o.mesh),o.material&&o.material.dispose(),this.heatmapMeshes.delete(a))}addStaticElements(){this.ambientLight=new THREE.HemisphereLight(3359061,659744,1.5),this.scene.add(this.ambientLight),this._skyCanvas=document.createElement("canvas"),this._skyCanvas.width=2,this._skyCanvas.height=128,this._skyTexture=new THREE.CanvasTexture(this._skyCanvas);const t=new THREE.SphereGeometry(450,16,8),e=new THREE.MeshBasicMaterial({map:this._skyTexture,side:THREE.BackSide,depthWrite:!1,fog:!1});this._skyDome=new THREE.Mesh(t,e),this.scene.add(this._skyDome),this._paintSkyGradient(0),this.dirLight=new THREE.DirectionalLight(3718648,1),this.dirLight.position.set(5,25,7),this.dirLight.castShadow=!0,this.dirLight.shadow.mapSize.set(2048,2048),this.dirLight.shadow.camera.near=1,this.dirLight.shadow.camera.far=80,this.dirLight.shadow.camera.left=-30,this.dirLight.shadow.camera.right=30,this.dirLight.shadow.camera.top=30,this.dirLight.shadow.camera.bottom=-30,this.dirLight.shadow.bias=-.0015,this.scene.add(this.dirLight);const i=new THREE.BufferGeometry,a=500,o=new Float32Array(a*3);for(let f=0;f<a*3;f+=3){const p=100+Math.random()*50,E=Math.random(),b=Math.random(),v=E*2*Math.PI,_=Math.acos(2*b-1);o[f]=p*Math.sin(_)*Math.cos(v),o[f+1]=p*Math.sin(_)*Math.sin(v),o[f+2]=p*Math.cos(_)}i.setAttribute("position",new THREE.BufferAttribute(o,3));const n=new THREE.PointsMaterial({color:16777215,size:.5,transparent:!0,opacity:.6});this.starField=new THREE.Points(i,n),this.scene.add(this.starField),this.cloudGroup=new THREE.Group;const l=document.createElement("canvas");l.width=128,l.height=128;const h=l.getContext("2d"),c=h.createRadialGradient(64,64,0,64,64,64);c.addColorStop(0,"rgba(148,163,184,0.35)"),c.addColorStop(1,"rgba(148,163,184,0)"),h.fillStyle=c,h.fillRect(0,0,128,128);const s=new THREE.CanvasTexture(l),r=new THREE.SpriteMaterial({map:s,transparent:!0,opacity:.5,depthWrite:!1});for(let f=0;f<14;f++){const p=new THREE.Sprite(r),E=10+Math.random()*14;p.scale.set(E,E*.5,1),p.position.set((Math.random()-.5)*90,18+Math.random()*10,(Math.random()-.5)*90),this.cloudGroup.add(p)}this.scene.add(this.cloudGroup);const u=40;this.terrainGeo=new THREE.PlaneGeometry(u,u,30,30);const d=this.terrainGeo.attributes.position.count,m=new Float32Array(d*3);m.fill(.02),this.terrainGeo.setAttribute("color",new THREE.BufferAttribute(m,3));const w=new THREE.MeshLambertMaterial({color:330516,side:THREE.FrontSide});this.terrainMapMesh=new THREE.Mesh(this.terrainGeo,w),this.terrainMapMesh.rotation.x=-Math.PI/2,this.terrainMapMesh.position.y=-.005,this.terrainMapMesh.receiveShadow=!0,this.scene.add(this.terrainMapMesh);const y=new THREE.MeshStandardMaterial({vertexColors:!0,roughness:.85,metalness:0,transparent:!0,opacity:.6,side:THREE.FrontSide});this.terrainMesh=new THREE.Mesh(this.terrainGeo,y),this.terrainMesh.rotation.x=-Math.PI/2,this.terrainMesh.receiveShadow=!0,this.scene.add(this.terrainMesh);const g=new THREE.MeshBasicMaterial({color:62206,wireframe:!0,transparent:!0,opacity:.15});this.terrainWire=new THREE.Mesh(this.terrainGeo,g),this.terrainWire.rotation.x=-Math.PI/2,this.terrainWire.visible=this.config.show_grid!==!1,this.scene.add(this.terrainWire),this.addRangeRings()}addWeatherStations(){this.stationMeshes=[],this.stations.forEach(t=>{const e=new THREE.Group,i=this.getTerrainHeight(t.x,t.z);e.position.set(t.x,i,t.z),e.userData={station:t};const a=.15,o=.5,n=Math.sqrt(o*o+a*a),l=new THREE.CylinderGeometry(.04,.05,n,6),h=new THREE.MeshStandardMaterial({color:3359061,roughness:.6,metalness:.5});for(let M=0;M<3;M++){const x=M/3*Math.PI*2,R=Math.cos(x)*o,H=Math.sin(x)*o,T=new THREE.Mesh(l,h);T.position.set(R/2,a/2,H/2);const S=new THREE.Vector3(-R,a,-H).normalize();T.quaternion.setFromUnitVectors(new THREE.Vector3(0,1,0),S),T.castShadow=!0,T.receiveShadow=!0,e.add(T)}const c=new THREE.CylinderGeometry(.12,.14,.1,12),s=new THREE.Mesh(c,h);s.position.y=a,s.castShadow=!0,s.receiveShadow=!0,e.add(s);const r=new THREE.RingGeometry(.8,1,32),u=new THREE.MeshBasicMaterial({color:t.color,transparent:!0,opacity:.8,side:THREE.DoubleSide}),d=new THREE.Mesh(r,u);d.rotation.x=-Math.PI/2,d.position.y=.03,e.add(d),e.userData.pulseRing=d;const m=new THREE.CylinderGeometry(.08,.15,2.5,8),w=new THREE.MeshStandardMaterial({color:t.color,roughness:.5,metalness:.4,transparent:!0,opacity:.6}),y=new THREE.Mesh(m,w);y.position.y=1.35,y.castShadow=!0,e.add(y),e.userData.towerCyl=y;const g=new THREE.BoxGeometry(.9,.06,.06),f=new THREE.MeshStandardMaterial({color:9741240,metalness:.5,roughness:.4}),p=new THREE.Mesh(g,f);p.position.y=2.3,p.castShadow=!0,e.add(p);const E=new THREE.SphereGeometry(.25,16,16),b=new THREE.MeshBasicMaterial({color:t.color}),v=new THREE.Mesh(E,b);v.position.y=2.7,e.add(v),e.userData.topSphere=v;const _=this.createRingLabelSprite(t.id);_.scale.set(3.2,1.6,1),_.position.y=3.6,e.add(_),this.scene.add(e),this.stationMeshes.push({mesh:e,pulseVal:Math.random()*Math.PI,strikeIntensity:0})})}initWeatherSystem(){const a=new THREE.BufferGeometry,o=new Float32Array(800*3);for(let r=0;r<800*3;r+=3)o[r]=(Math.random()-.5)*40,o[r+1]=18+Math.random()*4,o[r+2]=(Math.random()-.5)*40;a.setAttribute("position",new THREE.BufferAttribute(o,3));const n=new THREE.PointsMaterial({color:9684477,size:.15,transparent:!0,opacity:.6,depthWrite:!1});this.rainParticles=new THREE.Points(a,n),this._rainCloudBase=18,this._rainCloudSpread=4,this.scene.add(this.rainParticles),this.rainParticles.visible=!1;const l=300,h=new THREE.BufferGeometry,c=new Float32Array(l*3);for(let r=0;r<l*3;r+=3)c[r]=(Math.random()-.5)*40,c[r+1]=Math.random()*8,c[r+2]=(Math.random()-.5)*40;h.setAttribute("position",new THREE.BufferAttribute(c,3));const s=new THREE.PointsMaterial({color:3718648,size:.1,transparent:!0,opacity:.3,depthWrite:!1});this.windParticles=new THREE.Points(h,s),this.scene.add(this.windParticles),this.windParticles.visible=!1}updateWeatherOverlay(){if(!this.weatherOverlay)return;const t=(this.windSpeed||0).toFixed(1),e=(this.rainRate||0).toFixed(1),i=this.windDirection||0,a=`${this.hudCollapsed?1:0}|${this.showHeightColor?1:0}|${t}|${e}|${i}`;if(this._lastWeatherOverlaySignature!==a){if(this._lastWeatherOverlaySignature=a,this.hudCollapsed){this.weatherOverlay.innerHTML=`
    ...
    `,this.wrapper.appendChild(t),this.controls=document.createElement("div"),this.controls.style.display="flex",this.controls.style.alignItems="center",this.controls.style.padding="8px 12px",this.controls.style.backgroundColor="#080c14",this.controls.style.borderTop="1px solid rgba(56, 189, 248, 0.1)",this.controls.style.gap="12px",this.controls.style.fontFamily="var(--paper-font-body1_-_font-family, inherit)",this.controls.style.color="#e2e8f0",this.wrapper.appendChild(this.controls),this.playBtn=document.createElement("button"),this.playBtn.className="play-btn",this.playBtn.innerHTML=this.getPlayIcon(),this.controls.appendChild(this.playBtn),this.slider=document.createElement("input"),this.slider.type="range",this.slider.className="timeline-slider",this.slider.min="0",this.slider.max="1000",this.slider.value="1000",this.controls.appendChild(this.slider),this.speedSelect=document.createElement("select"),this.speedSelect.className="speed-select";const e=[1,5,10,30,60,120,300,600];e.includes(this.playbackSpeed)||(e.push(this.playbackSpeed),e.sort((i,a)=>i-a)),e.forEach(i=>{const a=document.createElement("option");a.value=i.toString(),a.innerText=`${i}x`,i===this.playbackSpeed&&(a.selected=!0),this.speedSelect.appendChild(a)}),this.controls.appendChild(this.speedSelect),this.timeLabel=document.createElement("span"),this.timeLabel.style.fontSize="12px",this.timeLabel.style.minWidth="130px",this.timeLabel.style.textAlign="right",this.timeLabel.style.color="#94a3b8",this.timeLabel.style.fontVariantNumeric="tabular-nums",this.timeLabel.innerText="Live",this.controls.appendChild(this.timeLabel),this.playBtn.addEventListener("click",()=>this.togglePlay()),this.slider.addEventListener("input",i=>this.handleSliderInput(i)),this.speedSelect.addEventListener("change",i=>{this.playbackSpeed=parseFloat(i.target.value)||120})}getPlayIcon(){return'<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M320-203v-554l440 277-440 277Z"/></svg>'}getPauseIcon(){return'<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M560-200v-560h160v560H560Zm-320 0v-560h160v560H240Z"/></svg>'}tickPlayback(){const t=this.strikeHistory.length>0?Math.min(Date.now()-P,this.strikeHistory[0].time):Date.now()-P,e=Date.now();if(this.slider&&(this.slider.disabled=!1),this.playbackMode==="live")this.playbackTime=e,this.slider&&(this.slider.min=t.toString(),this.slider.max=e.toString(),this.slider.value=e.toString()),this.timeLabel&&(this.timeLabel.innerText="Live");else if(this.isPlaying){const i=Date.now(),a=i-(this.lastPlayTickTime||i);this.lastPlayTickTime=i,this.playbackTime+=a*this.playbackSpeed,this.playbackTime>=e?(this.playbackTime=e,this.setLiveMode()):(this.slider&&(this.slider.min=t.toString(),this.slider.max=e.toString(),this.slider.value=this.playbackTime.toString()),this.updateTimeLabel(),this.checkAndTriggerPlaybackStrikes())}else this.slider&&(this.slider.min=t.toString(),this.slider.max=e.toString()),this.updateTimeLabel()}togglePlay(){const t=this.strikeHistory.length>0?Math.min(Date.now()-P,this.strikeHistory[0].time):Date.now()-P;this.playbackMode==="live"?(this.playbackMode="playback",this.isPlaying=!0,this.lastPlayTickTime=Date.now(),this.playbackTime=t,this.strikeHistory.forEach(e=>{e.animated=e.time<=this.playbackTime})):(this.isPlaying=!this.isPlaying,this.isPlaying&&(this.lastPlayTickTime=Date.now(),this.playbackTime>=Date.now()&&(this.playbackTime=t,this.strikeHistory.forEach(e=>{e.animated=e.time<=this.playbackTime})))),this.updatePlayBtnIcon()}setLiveMode(){this.playbackMode="live",this.isPlaying=!1,this.updatePlayBtnIcon(),this.slider&&(this.slider.value=Date.now()),this.timeLabel&&(this.timeLabel.innerText="Live"),this.strikeHistory.forEach(t=>t.animated=!0)}updatePlayBtnIcon(){this.isPlaying?(this.playBtn.innerHTML=this.getPauseIcon(),this.playBtn.style.color="#ef4444"):(this.playBtn.innerHTML=this.getPlayIcon(),this.playBtn.style.color="#38bdf8")}updateTimeLabel(){const e=new Date(this.playbackTime).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"}),i=Math.round((Date.now()-this.playbackTime)/1e3);let a="";if(i<60)a=`-${i}s`;else{const o=Math.floor(i/60),n=i%60;a=`-${o}m ${n}s`}this.timeLabel&&(this.timeLabel.innerText=`${e} (${a})`)}handleSliderInput(t){this.playbackMode="playback",this.isPlaying=!1,this.playbackTime=parseFloat(t.target.value),this.updatePlayBtnIcon(),this.updateTimeLabel(),this.strikeHistory.forEach(e=>{e.time<=this.playbackTime?e.animated=!0:e.animated=!1})}checkAndTriggerPlaybackStrikes(){this.strikeHistory.forEach(t=>{t.time<=this.playbackTime?t.animated||(t.animated=!0,this.triggerStrikeAnimation(t.x,t.z,t.stations)):t.animated=!1})}createLightningPath(t,e,i=10){const a=[],o=new THREE.Vector3().subVectors(e,t);a.push(t.clone());for(let n=1;n<i;n++){const l=n/i,h=new THREE.Vector3().addVectors(t,o.clone().multiplyScalar(l)),c=(1-l)*1;h.add(new THREE.Vector3((Math.random()-.5)*c,(Math.random()-.5)*c,(Math.random()-.5)*c)),a.push(h)}return a.push(e.clone()),a}createLightningBranches(t,e,i=8){const a=this.createLightningPath(t,e,i),o=[a];for(let n=1;n<a.length-2;n++)if(Math.random()<.25){const l=a[n].clone(),c=(1-n/a.length)*6,s=new THREE.Vector3().subVectors(e,t).normalize();s.add(new THREE.Vector3((Math.random()-.5)*1.5,-.2,(Math.random()-.5)*1.5)).normalize();const r=new THREE.Vector3().addVectors(l,s.multiplyScalar(c)),u=this.createLightningPath(l,r,4);o.push(u)}return o}_scheduleRaf(t){const e=requestAnimationFrame(i=>{this._activeRafIds.delete(e),t(i)});return this._activeRafIds.add(e),e}triggerStrikeAnimation(t,e,i=[]){if(!this.initialized)return;const a=this.getTerrainHeight(t,e),o=new THREE.Vector3(t,a,e),n=new THREE.Vector3(t+(Math.random()-.5)*4,a+18,e+(Math.random()-.5)*4);if(this.stationMeshes&&this.stationMeshes.forEach(f=>{(!i||i.length===0||i.some(E=>String(E)===String(f.mesh.userData.station.id)))&&(f.strikeIntensity=1)}),this.ambientLight){const f=this.ambientLight.intensity;this.ambientLight.intensity=4;let p=0;const E=()=>{!this.initialized||!this.ambientLight||(p++,this.ambientLight.intensity=Math.max(f,4*(1-p/8)),p<8&&this._scheduleRaf(E))};this._scheduleRaf(E)}const l=[];this.createLightningBranches(n,o).forEach((f,p)=>{const E=new THREE.CatmullRomCurve3(f),b=p===0,v=new THREE.TubeGeometry(E,Math.max(10,f.length*3),b?.06:.03,5,!1),_=new THREE.MeshStandardMaterial({color:b?16777215:16769126,emissive:b?16766720:16757504,emissiveIntensity:b?3:1.5,transparent:!0,opacity:b?1:.75,depthWrite:!1}),M=new THREE.Mesh(v,_);this.strikeLayer.add(M),l.push(M)});const c=new THREE.SpriteMaterial({map:this.glowTexture,color:16777215,transparent:!0,blending:THREE.AdditiveBlending,depthWrite:!1}),s=new THREE.Sprite(c);s.position.copy(o),s.position.y+=.1,s.scale.set(.1,.1,1),this.strikeLayer.add(s);const r=new THREE.RingGeometry(.1,.2,32),u=new THREE.MeshBasicMaterial({color:15680580,transparent:!0,opacity:.8,side:THREE.DoubleSide}),d=new THREE.Mesh(r,u);d.position.copy(o),d.position.y+=.05,d.rotation.x=-Math.PI/2,this.strikeLayer.add(d);const m=[];this.stations.forEach(f=>{const p=this.getTerrainHeight(f.x,f.z),E=new THREE.Vector3(f.x,p,f.z),b=E.distanceTo(o),v=new THREE.RingGeometry(b-.08,b+.08,64),_=new THREE.MeshBasicMaterial({color:f.color,transparent:!0,opacity:0,side:THREE.DoubleSide}),M=new THREE.Mesh(v,_);M.position.copy(E),M.position.y+=.05,M.rotation.x=-Math.PI/2,this.strikeLayer.add(M),m.push({mesh:M,targetOpacity:.5})});let w=0;const y=U,g=()=>{if(!this.initialized||!this.strikeLayer)return;w++;const f=w/y;if(f<.2?l.forEach(p=>p.material.opacity=Math.random()>.3?1:.2):f<.5?l.forEach(p=>{p.material.opacity=1-(f-.2)/.3}):l.forEach(p=>{p.parent&&(this.strikeLayer.remove(p),p.geometry&&p.geometry.dispose(),p.material&&p.material.dispose())}),f<.6){const p=f*12;s.scale.set(p,p,1),s.material.opacity=1*(1-f/.6)}else s.parent&&(this.strikeLayer.remove(s),s.material.dispose());if(f<.8){const p=1+f*25;d.scale.set(p,p,1),d.material.opacity=.8*(1-f/.8)}else d.parent&&(this.strikeLayer.remove(d),d.geometry&&d.geometry.dispose(),d.material&&d.material.dispose());m.forEach(p=>{f<.3?p.mesh.material.opacity=p.targetOpacity*(f/.3):f<.9?p.mesh.material.opacity=p.targetOpacity*(1-(f-.3)/.6):p.mesh.parent&&(this.strikeLayer.remove(p.mesh),p.mesh.geometry&&p.mesh.geometry.dispose(),p.mesh.material&&p.mesh.material.dispose())}),w<y&&this._scheduleRaf(g)};this._scheduleRaf(g)}_warnOnce(t,...e){this._warnedKeys.has(t)||(this._warnedKeys.add(t),console.warn(...e))}_elevationGridChanged(t){const e=this.elevationGrid;if(!e||t.length!==e.length)return!0;const i=t.length;if(i===0)return!1;const a=[0,Math.floor(i/4),Math.floor(i/2),Math.floor(3*i/4),i-1];for(const o of a)if(t[o]!==e[o])return!0;return!1}set hass(t){if(this._hass=t,!t||!this.initialized)return;const e=t.states,i="weatherflow_lightning_trilateration";let a,o;const n=[],l=[],h=Object.keys(e);for(let d=0;d<h.length;d++){const m=h[d],w=e[m];if(m.startsWith("sensor.")){const y=w.attributes;y.stations!==void 0&&(o||(o=m),!a&&m.endsWith("_stations")&&y.icon==="mdi:lightning-bolt"&&(a=m)),y.station_id!==void 0&&n.push({stationId:y.station_id,count:parseInt(w.state)||0})}else m.startsWith("geo_location.")&&w.attributes.source===i&&l.push(m)}const c=this.config.entity||this.config.entity_id||a||o;let s=t.config?.latitude??0,r=t.config?.longitude??0;if(c){const m=e[c].attributes.stations;if(Array.isArray(m)){const w=m.find(y=>y.type==="primary");if(w&&w.latitude!==void 0&&w.longitude!==void 0){const y=parseFloat(w.latitude),g=parseFloat(w.longitude);!isNaN(y)&&!isNaN(g)?(s=y,r=g):this._warnOnce("nan-primary-coords","WeatherFlow Card: Parsed primary station coordinates are NaN:",w.latitude,w.longitude)}else this._warnOnce("no-primary-station","WeatherFlow Card: No primary station found in stations list.")}else this._warnOnce("stations-not-array","WeatherFlow Card: stations attribute is not an array.")}else this._warnOnce("no-stations-sensor","WeatherFlow Card: No station sensor found \u2014 configure `entity` in the card config.");if((this.lastRefLat!==s||this.lastRefLon!==r)&&(this.lastRefLat=s,this.lastRefLon=r,this.loadMapTexture(s,r),this.vectorDataLoaded=!1),this.config.show_3d_features&&!this.vectorDataLoading&&!this.vectorDataLoaded&&this.loadVectorData(s,r),c){const d=e[c].attributes,m=d.elevation_grid;m&&this._elevationGridChanged(m)&&this.updateTerrainGeometry(m),this.windSpeed=d.wind_speed!==void 0?parseFloat(d.wind_speed):0,this.windDirection=d.wind_direction!==void 0?parseFloat(d.wind_direction):0,this.solarRadiation=d.solar_radiation!==void 0?parseFloat(d.solar_radiation):1e3,this.rainRate=d.rain_rate!==void 0?parseFloat(d.rain_rate):0,this.updateDayNightEngine(),this.updateWeatherOverlay(),this.lastStationStrikes||(this.lastStationStrikes={});for(const{stationId:y,count:g}of n){const f=this.lastStationStrikes[y];f!==void 0&&g>f&&this.stationMeshes&&this.stationMeshes.forEach(p=>{String(p.mesh.userData.station.id)===String(y)&&(p.strikeIntensity=1)}),this.lastStationStrikes[y]=g}const w=d.stations;if(Array.isArray(w)){let y=this.stations.length!==w.length;if(!y)for(let g=0;g<w.length;g++){const f=this.stations.find(b=>b.id===w[g].id),p=parseFloat(w[g].latitude),E=parseFloat(w[g].longitude);if(!f||f.lat!==p||f.lon!==E){y=!0;break}}y&&(this.stations=w.map(g=>{const f=parseFloat(g.latitude),p=parseFloat(g.longitude),{x:E,z:b}=this._latLonToGrid(f,p,s,r);let v=6583435;return g.type==="primary"?v=1096065:g.type==="neighbor"&&(v=3718648),{id:g.id,x:E,z:b,lat:f,lon:p,color:v,type:g.type}}),this.stationMeshes&&this.stationMeshes.forEach(g=>{this.scene.remove(g.mesh),this.disposeHierarchy(g.mesh)}),this.addWeatherStations())}}const u=[];l.forEach(d=>{const m=e[d],w=parseFloat(m.attributes.latitude),y=parseFloat(m.attributes.longitude),g=m.attributes.stations||[];if(!isNaN(w)&&!isNaN(y)){const{x:f,z:p}=this._latLonToGrid(w,y,s,r),E=new Date(m.last_changed).getTime();u.push({id:d,time:E,x:f,z:p,stations:g})}}),u.sort((d,m)=>d.time-m.time),u.forEach(d=>{if(!this.strikeHistory.some(m=>m.id===d.id)){const m=!this.knownStrikes.has(d.id);m&&this.knownStrikes.add(d.id);const w=this.playbackMode==="live"&&m;this.strikeHistory.push({id:d.id,time:d.time,x:d.x,z:d.z,stations:d.stations,animated:w||this.playbackMode!=="live"&&d.time<=this.playbackTime}),w&&this.triggerStrikeAnimation(d.x,d.z,d.stations)}}),this.strikeHistory=this.strikeHistory.filter(d=>u.some(m=>m.id===d.id)),this.strikeHistory.sort((d,m)=>d.time-m.time);for(const d of this.knownStrikes)t.states[d]||this.knownStrikes.delete(d)}getCardSize(){return 3}}customElements.define("weatherflow-lightning-card",K),window.customCards=window.customCards||[],window.customCards.push({type:"weatherflow-lightning-card",name:"WeatherFlow Lightning Trilateration Card",description:"WebGL 3D visualizer showing real-time lightning strike trilaterations."});class q extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}setConfig(t){if(this._config=t,!this._initializedEditor)this.render(),this._initializedEditor=!0;else{const e=this.shadowRoot.getElementById("height");e&&(e.value=this._config.height||"350px");const i=this.shadowRoot.getElementById("zoom_level");i&&(i.value=this._config.zoom_level!==void 0?this._config.zoom_level:"18.0");const a=this.shadowRoot.getElementById("show_grid");a&&(a.checked=this._config.show_grid!==!1);const o=this.shadowRoot.getElementById("show_map");o&&(o.checked=this._config.show_map!==!1);const n=this.shadowRoot.getElementById("show_rings");n&&(n.checked=this._config.show_rings!==!1);const l=this.shadowRoot.getElementById("show_heatmap");l&&(l.checked=this._config.show_heatmap!==!1);const h=this.shadowRoot.getElementById("auto_orbit");h&&(h.checked=this._config.auto_orbit!==!1);const c=this.shadowRoot.getElementById("show_weather");c&&(c.checked=this._config.show_weather!==!1);const s=this.shadowRoot.getElementById("show_daynight");s&&(s.checked=this._config.show_daynight!==!1);const r=this.shadowRoot.getElementById("min_brightness");r&&(r.value=this._config.min_brightness!==void 0?this._config.min_brightness:"0.8");const u=this.shadowRoot.getElementById("elevation_scale");u&&(u.value=this._config.elevation_scale!==void 0?this._config.elevation_scale:"1.5");const d=this.shadowRoot.getElementById("show_3d_features");d&&(d.checked=this._config.show_3d_features===!0);const m=this.shadowRoot.getElementById("playback_speed");m&&(m.value=this._config.playback_speed!==void 0?this._config.playback_speed.toString():"120"),this._syncEntityPicker()}}set hass(t){this._hass=t,this._syncEntityPicker()}render(){if(!this._config)return;this.shadowRoot.innerHTML=`
      <style>
        .card-config {
          display: flex;
          flex-direction: column;
